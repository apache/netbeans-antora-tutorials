...
image::kb/docs/php/page-flow-diagram.png[]
...
image::kb/docs/php/remove-php-block.png[]
...
image::kb/docs/php/form-dnd.png[]
...
image::kb/docs/php/insert-form-dialog.png[]

The file now looks like this:

image::kb/docs/php/blank-form.png[]
...
image::kb/docs/php/insert-text-input.png[]

The file now looks like this:

image::kb/docs/php/form-with-text-input.png[]
...
image::kb/docs/php/insert-button-dialog.png[]
...
3. Click the right mouse button on the Sources node and choose Run Project from the context menu or click the Run Main Project icon image:kb/docs/php/run-main-project-button.png[]on the toolbar if you have set your project as Main. 

image::kb/docs/php/index-php-works.png[]
...
image::kb/docs/php/wishlist-php-title-works.png[]
...
image::kb/docs/php/codecompletion.png[]

image::kb/docs/php/codecompletion-oci.png[]
...
image::kb/docs/php/wishlist-php-title-user-not-found-works.png[]
...
image::kb/docs/php/wishlist-php-works.png[]

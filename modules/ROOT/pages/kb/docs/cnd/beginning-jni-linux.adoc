...
|C and C++ compilers,  ``make`` ,  ``gdb``  |xref:front::community/releases/80/cpp-setup-instructions.adoc[Configuring the NetBeans IDE for C/C{pp}/Fortran] 
|===

See the xref:front::community/releases/80/install.adoc[NetBeans IDE 8.0 Installation Instructions] and xref:front::community/releases/80/cpp-setup-instructions.adoc[Configuring the NetBeans IDE for C/C{pp}/Fortran] for information on downloading and installing the required software.
...
[start=7]
. Find the Compilation Line area of the C Compiler options. Click in the text field of the Additional Options property and type  ``-shared -m32`` . image:./jni-project-properties-cmd-options.png[]

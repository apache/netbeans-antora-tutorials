...
image::./newproj-small.png[role="left", xref="image$./newproj.png"]
...
image::./newjframeform-small.png[role="left", xref="image$./newjframeform.png"]
...
image::./menubaradded-small.png[role="left", xref="image$./menubaradded.png"]
...
image::./menuitemadded-small.png[role="left", xref="image$./menuitemadded.png"]
...
image::./highlighting-small.png[role="left", xref="image$./highlighting.png"]
...
image::./textareadded-small.png[role="left", xref="image$./textareadded.png"]
...
image::./jfilechooserdemoview_final-small.png[role="left", xref="image$./jfilechooserdemoview_final.png"]
...
image::./combobox-small.png[role="left", xref="image$./combobox.png"]
...
image::./result_jfilechooserdemo-small.png[role="left", xref="image$./result_jfilechooserdemo.png"]

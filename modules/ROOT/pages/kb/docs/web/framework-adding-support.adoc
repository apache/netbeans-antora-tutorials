...
image::kb/docs/web/plugin-archive-contents.png[title="The zip archive contains the NetBeans plugins"]
...
image::kb/docs/web/add-plugins-sm.png[role="left", xref="image$./add-plugins.png"]
...
image::kb/docs/web/pluginsmanager-settings-sm.png[role="left", xref="image$./pluginsmanager-settings.png"]
...
image::kb/docs/web/uc-customizer.png[title="Update Center Customizer dialog box"] 
...
image::kb/docs/web/portal-uc-plugin-sm.png[role="left", xref="image$./portal-uc-plugin.png"]
...
image::kb/docs/web/portal-uc-list-sm.png[role="left", xref="image$./portal-uc-list.png"]
...
image::kb/docs/web/newproject-wizard-frameworks-sm.png[title="Struts 2 Support listed in Frameworks panel of the New Project wizard"]
...
image::kb/docs/web/project-structure-frameworks.png[title="Logical structure of Struts web application displayed in Projects window"]  
...
image::kb/docs/web/properties-add-framework.png[title="JavaServer Faces framework selected in the Add Framework dialog opened from the Project Properties window"]
...
image::kb/docs/web/add-icefaces.png[title="Adding a library for the ICEfaces component suite to the project"]

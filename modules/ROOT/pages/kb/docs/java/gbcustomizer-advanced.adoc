...
image::./sampleform-small.png[role="left", xref="image$./sampleform.png"]
...
image::./customizerdialog-small.png[role="left", xref="image$./customizerdialog.png"]
...
image::./addcomponent-small.png[role="left", xref="image$./addcomponent.png"]
...
image::./unwantedspace-small.png[role="left", xref="image$./unwantedspace.png"]
...
image::./enclose-small.png[role="left", xref="image$./enclose.png"]
...
image::./designsubcontainer-small.png[role="left", xref="image$./designsubcontainer.png"]
...
image::./emptycell-small.png[role="left", xref="image$./emptycell.png"]
...
image::./newbutton-small.png[role="left", xref="image$./newbutton.png"]

--



. Click the Baseline-Related Anchor button (image:./baselineanchor.png[]) in the Property Customizer to align the new button with the two existing ones in the row.


. Click the browse button (image:./browsebutton.png[]) to the right of the Insets text field. The Insets dialog box displays. Enter 5 in the Top: text field, and click OK.

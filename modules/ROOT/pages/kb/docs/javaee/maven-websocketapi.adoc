...
image::kb/docs/javaee/websocket-newproject.png[title="Server and Java EE versions in the New Project wizard"]
...
image::kb/docs/javaee/websocket-newendpoint.png[title="WebSocket Endpoint in the New File wizard"]
...
image::kb/docs/javaee/websocket-endpoint-hint.png[title="Code Hint in the Source Editor"]
...
image::kb/docs/javaee/websocket-browser1.png[title="Connected to endpoint message in browser window"]
...
image::kb/docs/javaee/websocket-generategetter.png[title="Generate Getter and Setter dialog box"]
...
image::kb/docs/javaee/websocket-generateconstructor.png[title="Generate Constructor popup menu"]
...
image::kb/docs/javaee/websocket-onebrowser.png[title="Canvas with figures in browser and JSON displayed in web console"]
...
image::kb/docs/javaee/websocket-twobrowsers.png[title="Two browsers sending JSON via the endpoint"]
...
image::kb/docs/javaee/websocket-onebrowser-binary.png[title="Web console in browser displaying message that binary data was sent"]

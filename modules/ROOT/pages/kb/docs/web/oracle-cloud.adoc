...
|xref:front::download/index.adoc[+NetBeans IDE+] |7.3, 7.4, 8.0, Java EE Version 
...
image::kb/docs/web/cloud-contextmenu.png[]
...
image::kb/docs/web/registered-cloud-and-server.png[]
...
image::kb/docs/web/jobs-n-logs.png[]
...
image::kb/docs/web/project-contextmenu.png[]


. In the Project Properties, select the Run category.

image::kb/docs/web/run-properties.png[]
...
image::kb/docs/web/output-cloud-tab.png[]
...
1. Enable the sample HR schema on your OracleXE database server and register the schema in NetBeans IDE. For details, see xref:kb/docs/ide/oracle-db.adoc[+Connecting to Oracle Database from NetBeans IDE+].
...
image::kb/docs/web/crudapp-eevers.png[]


image::kb/docs/web/crudapp-jsf.png[]
...
image::kb/docs/web/crudapp-properties.png[]
...
image::kb/docs/web/crudapp-persistence.png[]
...
image::kb/docs/web/new-servlet.png[]
...
image::kb/docs/web/cc-failure.png[]
...
image::kb/docs/web/whitelist-warning.png[]
...
image::kb/docs/web/whitelist-output.png[]
...
image::kb/docs/web/whitelist-tasks.png[]
...
image::kb/docs/web/whitelist-properties.png[]

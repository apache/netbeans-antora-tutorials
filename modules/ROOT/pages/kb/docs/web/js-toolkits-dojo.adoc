...
image::kb/docs/web/dojo-tree-complete.png[title="Completed exercise viewed in a browser"]
...
2. Click the Open Project button ( images:./open-project-btn.png[] ) in the IDE toolbar to open the Open Project dialog box.
...
image::kb/docs/web/proj-win-ref-problems.png[title="Project reference problems are indicated by red text and error badge"]
...
image::kb/docs/web/proj-win-dojo-resources.png[title="Dojo and Dijit libraries are added to the Project's 'resources' folder"]

Select the GlassFish Server in the Resolve References dialog box. Click OK.

image::kb/docs/web/dojo-add-server.png[title="Dojo and Dijit libraries are added to the Project's 'resources' folder"]
...
image::kb/docs/web/proj-win-json-sources.png[title="Sources are now contained in the new 'json' project"]
...
image::kb/docs/web/files-win-compiled-classes.png[title="Compiled sources can be viewed in a project's 'build' folder"]
...
image::kb/docs/web/libraries-json-jar.png[title="JAR file is referenced by the project"]
...
image::kb/docs/web/dojo-navigator.png[title="Use the Navigator to view class fields and properties"] 
...
image::kb/docs/web/javadoc-window.png[title="The Javadoc for TribeDataManager provides an example of JSON data"]
...
image::kb/docs/web/debugger-breakpoint.png[title="Use the Java Debugger to step through code"]
...
* xref:kb/docs/java/debug-stepinto-screencast.adoc[+Visual Step Into Action in NetBeans Debugger+]
* xref:kb/docs/java/debug-deadlock-screencast.adoc[+Deadlock Detection Using the NetBeans Debugger+]
* xref:kb/docs/java/debug-evaluator-screencast.adoc[+Using the Code Snippet Evaluator in the NetBeans Debugger+]
...
image::kb/docs/web/new-servlet-wizard.png[title="Use the New Servlet wizard to create servlets"]
...
. To run the project, select the `DojoTreeSample` project node in the Projects window, then click the Run Project ( images:./run-project-btn.png[] ) button in the IDE's toolbar. 

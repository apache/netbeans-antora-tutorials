...
image::kb/docs/ide/options-dialog-small.png[role="left", xref="image$./options-dialog.png"]
...
image::kb/docs/ide/clone-repository-small.png[role="left", xref="image$./clone-repository.png"]
...
image::kb/docs/ide/clone-username-small.png[role="left", xref="image$./clone-username.png"]
...
image::kb/docs/ide/clone-push-small.png[role="left", xref="image$./clone-push.png"]
...
image::kb/docs/ide/clone-destination-small.png[role="left", xref="image$./clone-destination.png"]
...
image::kb/docs/ide/repositoryrootpath.png[role="left", xref="image$./repositoryrootpath.png"]
...
image::kb/docs/ide/output-small.png[role="left", xref="image$./output.png"]
...
image::kb/docs/ide/status-small.png[role="left", xref="image$./status.png"]
...
image::kb/docs/ide/right-ui-small.png[role="left", xref="image$./right-ui.png"]
...
|*Gray* |image:kb/docs/ide/gray-text.png[] |Indicates that the file is ignored by Mercurial and will not be included in versioning commands (e.g. Update and Commit). Files can only be made to be ignored if they have not yet been versioned. 
...
image::kb/docs/ide/versioning-window.png[]
...
image::kb/docs/ide/mercurial-merge-small.png[role="left", xref="image$./mercurial-merge.png"]
...
image::kb/docs/ide/mercurial-commit-dialog-small.png[role="left", xref="image$./mercurial-commit-dialog.png"]

...
See the xref:front::community/releases/80/install.adoc[NetBeans IDE Installation Instructions] and xref:front::community/releases/80/cpp-setup-instructions.adoc[Configuring the NetBeans IDE for C/C{pp}/Fortran]
...
If you have not yet installed Cygwin, see the general Cygwin installation info in xref:front::community/releases/80/cpp-setup-instructions.adoc#cygwin[Configuring NetBeans IDE for C/C{pp}/Fortran]. You can install CUnit by selecting it in the Libs category in the setup program.

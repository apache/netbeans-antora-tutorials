...
image::./workbench-home.png[role="left", xref="image$./workbench-home.png"]
...
image::./workbench.png[role="left", xref="image$./workbench.png"]
...
image::./workbench-empty-canvas.png[role="left", xref="image$./workbench-empty-canvas.png"]
...
image::./wb-customer-table.png[role="left", xref="image$./wb-customer-table.png"]

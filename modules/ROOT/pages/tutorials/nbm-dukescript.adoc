...
image::./dukescript_81_repos-plugin.png[]
...
image:./dukescript_install.png[] This will require a restart of the IDE.
...
image:./dukescript_wizard_5.png[] Click Finish.
...
image::./dukescript_subprojects.png[] 

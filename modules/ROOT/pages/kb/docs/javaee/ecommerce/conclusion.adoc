...
image::kb/docs/javaee/ecommerce/jsf-request-processing-lifecycle.png[title="The JSF request processing lifecycle"]
...
image::kb/docs/javaee/ecommerce/logo.png[] 

The NetBeans E-commerce Tutorial and sample application were conceived of and written by Troy Giunipero. The application began as a project arising out of Sun's link:http://research.sun.com/SEED/[+SEED program+], and was developed from January 2009 to November 2010. The tutorial was prepared as part of ongoing efforts to provide documentation for the IDE's xref:kb/docs/java-ee.adoc[+Java EE &amp; Java Web Learning Trail+].

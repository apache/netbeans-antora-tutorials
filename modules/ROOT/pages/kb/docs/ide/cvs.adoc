...
image::./cvs-checkout-small.png[role="left", link="images/cvs-checkout.png"]
...
image::./folder-to-import-small.png[role="left", link="images/folder-to-import.png"]
...
image::./cvs-options-small.png[role="left", link="images/cvs-options.png"]
...
image::./cvs-versioning-window-small.png[role="left", link="images/cvs-versioning-window.png"]
...
image::./history-viewer-small.png[role="left", link="images/history-viewer.png"]
...
image::./exclude-from-commit-small.png[role="left", link="images/exclude-from-commit.png"]
...
image::./cvs-confirm-overwrite-small.png[role="left", link="images/cvs-confirm-overwrite.png"]
...
image::./cvs-branch-dialog-small.png[role="left", link="images/cvs-branch-dialog.png"]
...
image::./cvs-merge-branches-small.png[role="left", link="images/cvs-merge-branches.png"]
...
image::./conflict-resolver-small.png[role="left", link="images/conflict-resolver.png"]
...
image::./cvs-commit-dialog-small.png[role="left", link="images/cvs-commit-dialog.png"]

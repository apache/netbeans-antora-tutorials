...
See the xref:front::community/releases/80/install.adoc[NetBeans IDE Installation Instructions] and xref:front::community/releases/80/cpp-setup-instructions.adoc[Configuring the NetBeans IDE for C/C{pp}/Fortran] for information on downloading and installing the required software.
...
image::./debug_samples_C_Quote.png[]

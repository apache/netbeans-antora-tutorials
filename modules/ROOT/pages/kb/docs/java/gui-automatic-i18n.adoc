...
image::./finddialog_new_small.png[role="left", xref="image$./finddialog_new.png"]
...
image::./bundles_new_small.png[role="left", xref="image$./bundles_new.png"]
...
image::./finddialog_es_new_small.png[role="left", xref="image$./finddialog_es_new.png"]
...
image::./prjproperties_small.png[role="left", xref="image$./prjproperties.png"]
...
image::./run_small.png[role="left", xref="image$./run.png"]
...
image::./i18nwizardone_small.png[role="left", xref="image$./i18nwizardone.png"]
...
image::./i18nwizardtwo_small.png[role="left", xref="image$./i18nwizardtwo.png"]
...
image::./i18nwizardthree_small.png[role="left", xref="image$./i18nwizardthree.png"]
...
image::./i18ndialog_small.png[role="left", xref="image$./i18ndialog.png"]

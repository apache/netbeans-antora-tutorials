...
image::kb/docs/javaee/cdi-newpomproject.png[title="Maven POM Project archetype in the New Project wizard"]
...
image::kb/docs/javaee/cdi-new-osgiproject.png[title="Maven OSGi Bundle archetype in the New Project wizard"]
...
image::kb/docs/javaee/cdi-manifest.png[title="view the contents of the compiled JAR in the Files window"]
...
image::kb/docs/javaee/cdi-add-dependency.png[title="Open Projects tab in the Add Library dialog"]
...
image::kb/docs/javaee/cdi-activator.png[title="Activator class in the Projects window"]
...
image::kb/docs/javaee/cdi-implproject.png[title="Activator class in the Projects window"]
...
image::kb/docs/javaee/cdi-maven-repositories.png[title="GlassFish repository in the Maven Repositories window"]
...
image::kb/docs/javaee/cdi-add-dependency3.png[title="Dependency Management tab in the Add Library dialog"]
...
image::kb/docs/javaee/cdi-glassfish-addons.png[title="Update Tool GlassFish Admin Console"]
...
image::kb/docs/javaee/cdi-glassfish-console.png[title="Dependency Management tab in the Add Library dialog"]
...
* xref:wiki::wiki/OSGiAndNetBeans.adoc[+OSGi And NetBeans at wiki+]
* xref:wiki::wiki/MavenBestPractices.adoc[+Best Practices for Apache Maven in NetBeans IDE+]

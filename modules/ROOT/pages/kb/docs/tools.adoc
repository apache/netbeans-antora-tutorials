...
* xref:kb/docs/ide/mercurial-queues.adoc[+Using Mercurial Queues Support in NetBeans IDE+]
* xref:kb/docs/ide/git.adoc[+Using Git Support in NetBeans IDE+]
* xref:kb/docs/ide/mercurial.adoc[+Using Mercurial Support in Netbeans IDE+]
* xref:kb/docs/ide/subversion.adoc[+Using Subversion Support in Netbeans IDE+]
* xref:kb/docs/ide/cvs.adoc[+Using CVS Support in Netbeans IDE+]
* xref:kb/docs/ide/clearcase.adoc[+Using ClearCase Support in Netbeans IDE+]

=== Collaborative Development

* xref:kb/docs/ide/team-servers.adoc[+Working With a Team Server in NetBeans IDE+]
...
* xref:kb/docs/ide/github_nb_screencast.adoc[+Demo: Setting Up a GitHub Repository Using NetBeans IDE+]
* xref:kb/docs/ide/git_nb_ssh_screencast.adoc[+Demo: Cloning a Git Repository Using NetBeans IDE+]
* YouTube: link:http://www.youtube.com/watch?v=mQS-CViDHBU[+FindBugs in NetBeans IDE+] (_by Geertjan Wielenga_)

== Community-Contributed Docs

* Geertjan's Blog: xref:front::blogs/geertjan/git_in_netbeans_ide_7.adoc[Git with Rebase in NetBeans IDE]
* xref:wiki::wiki/TutorialUsingSVNLocalRepository.adoc[+Using a Subversion (SVN) Local Repository+]
* xref:wiki::wiki/AccessMssql.adoc[+Accessing MS Access / MS SQL from NetBeans+]
...
* xref:wiki::wiki/NetBeansUserFAQ.adoc#Version_Control_Systems[+Version Control FAQs+]
* xref:wiki::wiki/NetBeansUserFAQ.adoc#Database_Connectivity[+Database Connectivity FAQs+]

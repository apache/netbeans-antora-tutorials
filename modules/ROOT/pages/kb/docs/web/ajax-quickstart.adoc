...
image::./java-name-location.png[title="Specify the name and location for your application project"]
...
image::./java-server-settings.png[title="Specify the server your application will be deployed to"]
...
image::./java-proj-win.png[title="Projects window displays MyAjaxApp project"]
...
image::./insert-form.png[title="Insert form dialog"]
...
image::./code-completion.png[title="Press Ctrl-Space in the editor to invoke code completion and documentation support"]
...
image::./javascript-options.png[title="JavaScript Hint 0ptions in Options window"]
...
image::./insert-code.png[title="Insert Code popup menu displayed in Source Editor"]
...
image::./new-override.png[title="Override dialog lists inherited classes"]
...
image::./import-hint.png[title="Import hints display in left margin of the Source Editor"]
...
image::./css-styles-window.png[title="CSS Styles window displaying h1 rule properties"]
...
image::./css-completion.png[title="CSS code completion in the editor"]
...
image::./http-monitor.png[title="HTTP Server monitor displays in the IDE"]
...
image::./xml-data.png[title="HTTP Server monitor displays in the IDE"]

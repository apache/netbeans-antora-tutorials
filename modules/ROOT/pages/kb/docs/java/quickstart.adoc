...
image::./proj-wizard-maven2-small.png[role="left", link="images/proj-wizard-maven2.png"]
...
image::./proj-wizard2-maven-small.png[role="left", link="images/proj-wizard2-maven.png"]
...
image::./proj-wizard3-maven-small.png[role="left", link="images/proj-wizard3-maven.png"]
...
image::./proj-wizard4-maven-small.png[role="left", link="images/proj-wizard4-maven.png"]
...
image::./proj-opened-maven-small.png[role="left", link="images/proj-opened-maven.png"]
...
image::./file-opened-maven-small.png[role="left", link="images/file-opened-maven.png"]
...
image::./editor-cc-maven2-small.png[role="left", link="images/editor-cc-maven2.png"]
...
image::./run-output-maven-small.png[role="left", link="images/run-output-maven.png"]

...
image::kb/docs/javaee/appclient-newclasslibrary.png[title="New Class Library project wizard"]
...
image::kb/docs/javaee/appclient-newentappejb.png[title="Create EJB Module is selected in the New Enterprise Application wizard"]
...
image::kb/docs/javaee/appclient-projects-entappejb1.png[title="Projects window showing open projects"]
...
image::kb/docs/javaee/appclient-wizard-newsessionbean.png[title="New Session Bean wizard"]
...
image::kb/docs/javaee/appclient-projects-entappejb2.png[title="Projects window showing the session bean and remote interface"] 
...
image::kb/docs/javaee/appclient-wizard-newentappclient.png[title="Create Application Client selected in the New Project wizard"]
...
image::kb/docs/javaee/appclient-callenterprise.png[title="Call Enterprise Bean dialog"]
...
image::kb/docs/javaee/appclient-buildoutput.png[title="The result in the Output window"]

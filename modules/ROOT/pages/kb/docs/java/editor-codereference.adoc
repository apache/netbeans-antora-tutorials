...
image::kb/docs/java/code-folded2a.png[]
...
image::kb/docs/java/codecompletion3.png[]
...
image::kb/docs/java/codecompletion4.png[]
...
image::kb/docs/java/smartcompletion1.png[]
...
image::kb/docs/java/camelcase.png[]
...
image::kb/docs/java/keywords.png[]
...
image::kb/docs/java/parameter.png[]
...
image::kb/docs/java/prefixcompletion.png[]
...
image::kb/docs/java/subcompletion.png[]
...
image::kb/docs/java/exclude2-small.png[]
...
image::kb/docs/java/exclude.png[]
...
image::kb/docs/java/jpacompletion.png[]
...
image::kb/docs/java/imports3.png[]

When a non-imported class is found, the image:kb/docs/java/bulberror1.png[] error mark appears in the IDE's left-hand margin (also called the _glyph margin_). Click the error mark and choose whether to: add the missing import, create this class in the current package or, create this class in the current class.
...
image::kb/docs/java/imports2.png[]
...
image::kb/docs/java/imports.png[]

If there are unused import statements in your code, select the image:kb/docs/java/bulberror.png[] warning mark in the editor left-hand margin. Then choose either: to remove one unused import or, all unused imports.
...
image::kb/docs/java/codegeneration1.png[]
...
image::kb/docs/java/codegeneration2.png[]
...
In the code completion window, the constructors that can be generated automatically  are marked with the image:kb/docs/java/newconstructor.png[] icon and the " `generate` " note.
...
Code templates are marked with the image:kb/docs/java/codetemplateicon.png[] icon in the code completion window.

image::kb/docs/java/livetemplate.png[]
...
See xref:kb/docs/php/code-templates.adoc[+Code Templates in NetBeans IDE for PHP+], for more information about templates.
...
image::kb/docs/java/javadoc.png[]
...
image::kb/docs/java/javadoc1.png[]
...
The editor displays hints when Javadoc is missing or Javadoc tags are needed by displaying the bulb icon  image:kb/docs/java/bulb.gif[] in the left-hand margin, click the bulb icon to fix Javadoc errors.

image::kb/docs/java/javadoc2.png[]
...
image::kb/docs/java/javadoc3.png[]
...
image::kb/docs/java/generate.png[]
...
image::kb/docs/java/analyze-javadoc.png[]
...
For example, try typing `myBoolean=true`. The editor detects that this variable is not defined. Click the hint icon image:kb/docs/java/bulberror1.png[] and, see the editor suggests that you create a field, a method parameter, or a local variable.

image::kb/docs/java/quickfixes.png[]
...
Select a block in your code that you want to surround with a statement and click the bulb icon image:kb/docs/java/bulb.gif[] in the left-hand margin or, choose *Source > Fix Code* from the menu bar or, press:
...
image::kb/docs/java/surroundwith.png[]
...
image::kb/docs/java/coloring.png[]
...
image::kb/docs/java/highlightelement.png[]
...
image::kb/docs/java/gototype.png[]
...
image::kb/docs/java/gotoline.png[]
...
image::kb/docs/java/jumplastedit.png[]
...
image::kb/docs/java/breadcrumbs.png[]
...
image::kb/docs/java/jumprecentfile.png[]
...
image::kb/docs/java/togglefile.png[]
...
image::kb/docs/java/shift-f4.png[]
...
image::kb/docs/java/bookmark.png[]
...
image::kb/docs/java/bookmark2.png[]
...
image::kb/docs/java/bookmark3-small.png[]
...
image::kb/docs/java/navigatorwindow.png[]
...
|image:kb/docs/java/annotation_type.png[] |Annotation type |  |

|image:kb/docs/java/class_16.png[] |Class |  |

|image:kb/docs/java/package.png[] |Package |  |

|image:kb/docs/java/enum.png[] |Enum type |  |

|image:kb/docs/java/code_template.png[] |Code Template |  |

|image:kb/docs/java/constructor_16.png[] |Constructor |image:kb/docs/java/new_constructor_16.png[] |New constructor (generate)

|  |  |image:kb/docs/java/constructor_protected_16.png[] |Protected constructor

|  |  |image:kb/docs/java/constructor_private_16.png[] |Private constructor

|  |  |image:kb/docs/java/constructor_package_private_16.png[] |Package private constructor

|image:kb/docs/java/field_16.png[] |Field |image:kb/docs/java/field_protected_16.png[] |Protected field

|  |  |image:kb/docs/java/field_private_16.png[] |Private field

|  |  |image:kb/docs/java/field_package_private_16.png[] |Package private field

|image:kb/docs/java/field_static_16.png[] |Static field |image:kb/docs/java/field_static_protected_16.png[] |Protected static field

|  |  |image:kb/docs/java/field_static_private_16.png[] |Private static field

|  |  |image:kb/docs/java/field_static_package_private_16.png[] |Package private static field

|image:kb/docs/java/interface.png[] |Interface |  |

|image:kb/docs/java/javakw_16.png[] |Java keyword |  |

|image:kb/docs/java/method_16.png[] |Method |image:kb/docs/java/method_protected_16.png[] |Protected method

|  |  |image:kb/docs/java/method_private_16.png[] |Private method

|  |  |image:kb/docs/java/method_package_private_16.png[] |Package private method

|image:kb/docs/java/method_static_16.png[] |Static method |image:kb/docs/java/method_static_protected_16.png[] |Protected static method

|  |  |image:kb/docs/java/method_static_private_16.png[] |Private static method

|  |  |image:kb/docs/java/method_static_package_private_16.png[] |Package private static method

|image:kb/docs/java/localVariable.png[] |Local variable |  |

|image:kb/docs/java/attribute_16.png[] |Attribute |  |
|===

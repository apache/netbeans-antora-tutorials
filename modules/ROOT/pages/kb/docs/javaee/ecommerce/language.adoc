...
[start=3]
. Begin by creating a default resource bundle to contain text used in page views. Click the New File ( image:kb/docs/javaee/ecommerce/new-file-btn.png[] ) button in the IDE's toolbar. (Alternatively, press Ctrl-N; ⌘-N on Mac.)

[start=4]
. Under Categories select Other, then under File Types select Properties File. 

image::kb/docs/javaee/ecommerce/new-file-wzd.png[title="Create a new resource bundle using the File wizard"] 
...
image::kb/docs/javaee/ecommerce/new-properties-file-wzd.png[title="Specify the name and location of the resource bundle"]
...
image::kb/docs/javaee/ecommerce/new-locale-dialog.png[title="The New Locale dialog enables you to add a new locale to an existing resource bundle base name"] 
...
image::kb/docs/javaee/ecommerce/customizer-dialog.png[title="The New Locale dialog enables you to add a new locale to an existing resource bundle base name"]
...
image::kb/docs/javaee/ecommerce/projects-window.png[title="View resource bundles and the keys they contain in the Projects window"]
...
image::kb/docs/javaee/ecommerce/properties-editor.png[role="left", xref="image$./properties-editor.png"]
...
image::kb/docs/javaee/ecommerce/add-context-parameter.png[title="Add context parameters under the General tab for web.xml"]
...
image::kb/docs/javaee/ecommerce/firefox-content.png[title="Examine your browser's preferred languages"]
...
image::kb/docs/javaee/ecommerce/firefox-languages.png[title="Specify your browser's preferred languages"]

[start=5]
. Click OK, then press Esc to close Firefox' Options window.

[start=6]
. Run the project ( image:kb/docs/javaee/ecommerce/run-project-btn.png[] ). When the welcome page opens in your browser, note that text is displayed in Czech. 

image::kb/docs/javaee/ecommerce/czech-text.png[title="The displayed language is determined by your browser's language preferences"]
...
[start=3]
. Run the project ( image:kb/docs/javaee/ecommerce/run-project-btn.png[] ) to see what the toggle looks like in the browser. 

image::kb/docs/javaee/ecommerce/language-toggle.png[title="Run the project to view the language toggle"] 
...
[start=7]
. Run the project ( image:kb/docs/javaee/ecommerce/run-project-btn.png[] ) and examine the application welcome page in the browser. 

image::kb/docs/javaee/ecommerce/language-test.png[title="Language toggle displays according to request's preferred language"] 
...
`javax.servlet.jsp.jstl.fmt.locale.session` is the _string literal_ key for the `Locale` set by the `<fmt:setLocale>` tag. You can verify this by clicking in the editor's left margin to set a breakpoint ( image:kb/docs/javaee/ecommerce/breakpoint-badge.png[] ) on the new test, then running the debugger ( image:kb/docs/javaee/ecommerce/debug-project-btn.png[] ) on the project. When you click the toggle link to change languages in the browser, examine the Variables window (Alt-Shift-1; Ctrl-Shift-1 on Mac) when the debugger suspends on the breakpoint. 
[.feature]
--

image::kb/docs/javaee/ecommerce/variables-window.png[role="left", xref="image$./variables-window.png"]
...
image::kb/docs/javaee/ecommerce/toggle-page1.png[title="Welcome page displays according to browser's preferred language"] 
...
image::kb/docs/javaee/ecommerce/toggle-page2.png[title="Welcome page displays in English, according to toggle selection"] 
...
image::kb/docs/javaee/ecommerce/toggle-page3.png[title="Welcome page displays in Czech, according to toggle selection"] 
...
[start=6]
. Run the project ( image:kb/docs/javaee/ecommerce/run-project-btn.png[] ) to test it in the browser. When you navigate to the category, cart or checkout pages, switch languages using the language toggle. When you do so, you now remain within the same page view.
...
image::kb/docs/javaee/ecommerce/confirmation-page.png[title="Language toggle no longer displays in confirmation page"]

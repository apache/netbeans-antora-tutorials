...
image::kb/docs/web/movie-magic-quiz-design.png[]
...
image::kb/docs/web/built-project-files.png[]

The applet is launched in the Applet Viewer:

image::kb/docs/web/appletviewer.png[]

Applet forms are also displayed in the Applet Viewer:

image::kb/docs/web/movie-magic-quiz.png[]
...
[.feature]
--
images:./helloapplet-jar-in-files-small.png[role="left", xref="image$./helloapplet-jar-in-files.png"]
--
...
[.feature]
--
images:./appletinbrowser-small.png[role="left", xref="image$./appletinbrowser.png"]
--

For applet forms, you should see something similar to the following:

image::kb/docs/web/movie-magic-quiz-html.png[]

...
image::kb/docs/web/browser-test.png[title="View the empty HTML template in a browser window"]
...
image::kb/docs/web/blue-test.png[title="Text turns blue when clicked upon"] 
...
image::kb/docs/web/code-completion.png[title="Press Ctrl-Space to view code completion and API documentation windows"]
...
image::kb/docs/web/structured-list.png[title="Structured list displays in a browser"] 
...
image::kb/docs/web/accordion-list.png[title="Accordion widget handles user clicks and produces the accordion effect"]
...
image::kb/docs/web/ui-lightness-theme.png[title="jQuery default theme enhances the appearance of the accordion widget"]

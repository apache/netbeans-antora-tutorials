...
image::./cdi-diagram-alternative.png[title="Use CDI injection to loosely couple classes in your application"]
...
image::./output-window.png[title="View the server log in the Output window"]
...
image::./code-completion-alternative.png[title="Press Ctrl-Space on annotations to invoke Javadoc documentation"]
...
image::./cdi-diagram-lifecycle.png[title="Use CDI injection to loosely couple classes in your application"]

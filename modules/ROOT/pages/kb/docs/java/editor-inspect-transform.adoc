...
image::./manage-inspections-small.png[role="left", xref="image$./manage-inspections.png"]
...
image::./search-small.png[role="left", xref="image$./search.png"]
...
image::./jdk5-conf-small.png[role="left", xref="image$./jdk5-conf.png"]
...
image::./jdk7-conf-small.png[role="left", xref="image$./jdk7-conf.png"]
...
image::./jdk7-ref-small.png[role="left", xref="image$./jdk7-ref.png"]
...
image::./jdk8-conf-small.png[role="left", xref="image$./jdk8-conf.png"]
...
image::./org-imports-small.png[role="left", xref="image$./org-imports.png"]
...
image::./imports-ref-small.png[role="left", xref="image$./imports-ref.png"]
...
image::./custom-hint-small.png[role="left", xref="image$./custom-hint.png"]
...
image::./script-small.png[role="left", xref="image$./script.png"]
...
image::./hint-file-small.png[role="left", xref="image$./hint-file.png"]
...
image::./mycustomhint-small.png[role="left", xref="image$./mycustomhint.png"]

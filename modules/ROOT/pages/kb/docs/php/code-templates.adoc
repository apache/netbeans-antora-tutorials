...
. Click the Hint image:./hint-icon.png[] icon or press Alt-Enter. The Surround with... dialog opens.
...
image::./cursor-after-not-editing.png[]

image::./cursor-after-editing.png[]

...
* xref:wiki::wiki/JavaMEEmbeddedHowTo.adoc[+Java ME Embedded How To+]
...
* xref:wiki::wiki/JavaMESDKSupport.adoc[+FAQ on Java ME SDK Support in NetBeans IDE+]
* xref:kb/docs/mobility.adoc[Java ME and Java Card Application Technology Trail]

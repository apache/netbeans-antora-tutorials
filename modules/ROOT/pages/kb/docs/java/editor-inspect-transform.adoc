...
image::./manage-inspections-small.png[role="left", link="images/manage-inspections.png"]
...
image::./search-small.png[role="left", link="images/search.png"]
...
image::./single-inspection-small.png[role="left", link="images/single-inspection.png"]
...
image::./jdk5-conf-small.png[role="left", link="images/jdk5-conf.png"]
...
image::./jdk7-conf-small.png[role="left", link="images/jdk7-conf.png"]
...
image::./jdk7-ref-small.png[role="left", link="images/jdk7-ref.png"]
...
image::./jdk8-conf-small.png[role="left", link="images/jdk8-conf.png"]
...
image::./org-imports-small.png[role="left", link="images/org-imports.png"]
...
image::./imports-ref-small.png[role="left", link="images/imports-ref.png"]
...
image::./custom-hint-small.png[role="left", link="images/custom-hint.png"]
...
image::./script-small.png[role="left", link="images/script.png"]
...
image::./hint-file-small.png[role="left", link="images/hint-file.png"]
...
image::./mycustomhint-small.png[role="left", link="images/mycustomhint.png"]

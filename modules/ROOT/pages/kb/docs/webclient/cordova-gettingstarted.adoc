...
image::./cordova-newproject-wizard1.png[title="Cordova Application template in the New Project wizard"]
...
image::./cordova-newproject-wizard2.png[title="Site Templates panel in the New HTML5 Application wizard"]
...
image::./cordova-newproject-wizard3.png[title="JavaScript Libraries panel in the New HTML5 Application wizard"]
...
image::./cordova-projects-window1.png[title="Projects window"]
...
image::./cordova-select-browser.png[title="Browser selected in dropdown list in toolbar"]
...
image::./cordova-ios7-run.png[title="Application in the iOS Simulator"]
...
image::./cordova-code-completion.png[title="Code completion in the editor"]
...
image::./cordova-properties-application.png[title="Cordova Plugins tab in the Project Properties window"]
...
image::./cordova-properties-plugins.png[title="Cordova Plugins tab in the Project Properties window"]
...
image::./cordova-ios7-run1.png[title="Prompt for location in the application"]
...
image::./cordova-ios-customlocation.png[title="Custom Location dialog box in iOS Simulator"]
...
image::./cordova-ios7-run3.png[title="Application when using a custom location in the iOS Simulator"]
...
image::./cordova-debug-breakpoint1.png[title="Debugger stopped on breakpoint"]
...
image::./cordova-debug-variables1b.png[title="Tooltip showing variables"]

If your cursor is over `position` or `coords` the tooltip contains an arrow that you can click to expand the tooltip.

image::./cordova-debug-variables1a.png[title="Tooltip showing variables"]

The expanded tooltip enables you to see the values in greater detail.

image::./cordova-debug-variables2.png[title="Tooltip showing variables"]
...
image::./cordova-debug-variables.png[title="Variables window"]

In the Network Monitor window you can see a list of the application requests.

image::./cordova-network-monitor.png[title="Variables window"]

...
image::./quickstart_platform_new-project-1.png[]
...
image::./quickstart_platform_new-project-2.png[]

Click btn:[Finish]. The new project appears as follows in the Projects window:


image::./quickstart_platform_new-project-3.png[]
...
image::./quickstart_platform_new-module-1.png[]

The New Module Project dialog will appear. 
Name the new module `WordEditorCore`:


image::./quickstart_platform_new-module-2.png[]
...
image::./quickstart_platform_new-window-1.png[]

The New File dialog appears. In the Module Development category, select "Window":

image::./quickstart_platform_new-window-2.png[]
...
image::./quickstart_platform_new-window-3.png[]
...
image::./quickstart_platform_new-window-6.png[]
...
image::./quickstart_platform_new-window-7.png[]
...
image::./quickstart_platform_new-app-1.png[]
...
image::./quickstart_platform_new-app-2.png[]


[start=2]
1. Enter a text in lowercase in the text area, and click "Filter!".

image::./quickstart_platform_new-app-3.png[]

You should see that the text is now shown in uppercase:

image::./quickstart_platform_new-app-4.png[]
...
image::./quickstart_platform_new-api-4.png[]
...
image::./quickstart_platform_new-api-8.png[]
...
image::./quickstart_platform_new-api-9.png[]
...
image::./quickstart_platform_new-api-10.png[]
...
image::./quickstart_platform_new-impl-1.png[]

Name the new module "UppercaseFilter":

image::./quickstart_platform_new-impl-2.png[]

Click btn:[Next]. Set the Code Name Base to `org.word.editor.uppercase`, as shown below:

image::./quickstart_platform_new-impl-3.png[]
...
image::./quickstart_platform_new-impl-6.png[]

Click btn:[OK].

A confirmation dialog will appear:

image::./quickstart_platform_new-impl-7.png[]
...
image::./quickstart_platform_new-impl-8.png[]
...
image::./quickstart_platform_new-impl-9.png[]

Name the new class `UppercaseFilter`:

image::./quickstart_platform_new-impl-10.png[]
...
image::./quickstart_platform_new-impl-11.png[]

Add the WordEditorAPI dependency:

image::./quickstart_platform_new-impl-12.png[]

Expand the Libraries entries to verify the dependency as been added:

image::./quickstart_platform_new-impl-13.png[]
...
image::./quickstart_platform_new-impl-14.png[]
...
image::./quickstart_platform_new-impl-15.png[]
...
image::./quickstart_platform_new-history-1.png[]
...
image::./quickstart_platform_new-history-2.png[]
...
image::./quickstart_platform_new-history-3.png[]
...
image::./quickstart_platform_new-result-1.png[]
...
image::./quickstart_platform_new-result-2.png[]

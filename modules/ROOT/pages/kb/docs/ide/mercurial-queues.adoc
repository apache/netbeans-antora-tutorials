...
image::./create-patch-small.png[role="left", link="images/create-patch.png"]
...
image::./refresh-patch-small.png[role="left", link="images/refresh-patch.png"]
...
image::./qdiff-small.png[role="left", link="images/qdiff.png"]

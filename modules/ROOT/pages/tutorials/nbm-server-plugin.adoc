...
xref:front::community/mailing-lists.adoc[Feedback]
...
For more information on working with NetBeans modules, see the  xref:../kb/docs/platform.adoc[ NetBeans Module and Rich-Client Application tutorials page] on the NetBeans website. If you have questions, visit the  xref:wiki::wiki/NetBeansDeveloperFAQ.adoc[ NetBeans Developer FAQ] or use the feedback link at the top of this page.
...
* NetBeans IDE 5.5 ( xref:front::download/index.adoc[download]). Note that this tutorial was originally written for NetBeans IDE 5.0, but that version of this tutorial is no longer supported.
...
image::./myserver_projects-window.png[]
...
image::./myserver_choose-server.png[]
...
image::./myserver_add-server-instance.png[]
...
image::./myserver_add-server-instance3.png[]
...
image::./myserver_runtime-window.png[]
...
image::./myserver_name-and-location-panel.png[]
...
image::./myserver_projects-window-factories.png[]
...
image::./myserver_projects-window-mainfunctionality.png[]
...
image::./myserver_projects-window-supporting.png[]
...
image::./myserver_projects-window-original.png[]
...
image::./myserver_libraries-panel.png[]
...
image::./myserver_jboss-server.png[]

...
image::kb/docs/php/sample-app.png[title="Sample application displayed in browser"]
...
image::kb/docs/php/ajax-process-flow.png[title="Ajax process flow diagram"]
...
image::kb/docs/php/php-name-location.png[title="New PHP Project wizard - Name and Location panel"]
...
image::kb/docs/php/php-run-config.png[role="left", xref="image$./php-run-config.png"]
...
image::kb/docs/php/php-proj-win.png[title="Projects window displays MyAjaxApp project"]
...
image::kb/docs/php/palette.png[title="Palette displaying HTML elements"] 
...
image::kb/docs/php/php-insert-form.png[title="Insert form dialog"]
...
image::kb/docs/php/insert-table.png[title="Insert table dialog"]
...
image:kb/docs/php/code-completion.png[title="Ctrl-Space triggers code completion in the Source Editor"] 
...
To do so, right-click the project node in the Projects window and choose Properties. Select the *Run Configuration* category, then enter `index.html` in the Index File field. image:kb/docs/php/php-entry-point.png[title="Specify the application's entry point in the Project Properties window"]


. Click OK to save changes and exit the Project Properties window.


. Run the project to see what it looks like in a browser. Click the Run Project ( image:kb/docs/php/run-project-btn.png[] ) button. The `index.html` file displays in your default browser. 
image:kb/docs/php/index-page.png[title="Run project to view its current state in browser"]
...
image::kb/docs/php/php-javascript-options.png[title="JavaScript Options panel"]
...
image:kb/docs/php/edit-file-name.png[title="Click on file nodes to edit names"]
...
1. Run the project to see what it looks like in a browser. Click the Run Project ( image:kb/docs/php/run-project-btn.png[] ) button. The `index.html` file displays in your browser. 
image:kb/docs/php/no-css.png[title="Successful deployment without stylesheet"]

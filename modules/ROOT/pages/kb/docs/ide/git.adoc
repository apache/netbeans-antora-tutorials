...
image::./initialize-git-repo-small.png[role="left", link="images/initialize-git-repo.png"]
...
image::./clone-wizard-small.png[role="left", link="images/clone-wizard.png"]
...
image::./github-repo-small.png[role="left", link="images/github-repo.png"]
...
image::./github-branches-small.png[role="left", link="images/github-branches.png"]
...
image::./github-destination-small.png[role="left", link="images/github-destination.png"]
...
[start=4]
. In the Commit dialog box, select the Changes between HEAD and Index ( image:./changes-head-index.png[] ) toggle button. This displays the list of files that are already staged.
...
[start=3]
. In the Commit dialog box, select the Select the Changes between HEAD and Working Tree (image:./changes-head-wt.png[]) toggle button. This displays the list of files that are not staged.
...
image::./versioning-view-small.png[role="left", link="images/versioning-view.png"]
...
image::./versioning-right-click-small.png[role="left", link="images/versioning-right-click.png"]
...
image::./diff-viewer-small.png[role="left", link="images/diff-viewer.png"]
...
image::./commit-small.png[role="left", link="images/commit.png"]
...
image::./create-branch-small.png[role="left", link="images/create-branch.png"]
...
image::./branch-added-small.png[role="left", link="images/branch-added.png"]
...
image::./chkout-rev-small.png[role="left", link="images/chkout-rev.png"]
...
image::./chkout-path-small.png[role="left", link="images/chkout-path.png"]
...
image::./merge-small.png[role="left", link="images/merge.png"]
...
image::./fetch-small.png[role="left", link="images/fetch.png"]
...
image::./pull-small.png[role="left", link="images/pull.png"]
...
image::./push-small.png[role="left", link="images/push.png"]

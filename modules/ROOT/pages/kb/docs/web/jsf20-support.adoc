...
image::kb/docs/web/new-proj-wizard-framework.png[title="Add JSF Framework support when creating a project"]
...
image::kb/docs/web/jsf-configuration.png[title="Specify Faces servlet settings under the Configuration tab"]
...
image::kb/docs/web/doc-support.png[title="Press Ctrl-Space to invoke code completion and documentation support"]
...
image::kb/docs/web/code-completion.png[title="Press Ctrl-Space in the editor to invoke a list of items"]

You can press Ctrl-Space to invoke code completion for Facelets namespaces.

image::kb/docs/web/namespace.png[title="Press Ctrl-Space to complete Facelets namespaces"]
...
image::kb/docs/web/el-code-completion.png[title="Press Ctrl-Space on EL expressions to invoke completion support for implicit objects, JSF managed beans, and bean properties"]
...
image::kb/docs/web/faces-config-menu.png[title="JSF-specific dialogs provided in faces-config.xml's right-click menu"]
...
image::kb/docs/web/page-flow.png[title="PageFlow view displays navigation relationships"]
...
image::kb/docs/web/file-wizard.png[title="JSF-oriented wizards are accessible from the File wizard"]
...
image::kb/docs/web/jsf-file-wizard.png[title="Create Facelets pages using the IDE's JSF File wizard"]
...
image::kb/docs/web/managed-bean.png[title="Create JSF managed beans using the IDE's Managed Bean wizard"]
...
image::kb/docs/web/convert-comp-component.png[title="Highlight a snippet, and choose Convert to Composite Component from the right-click menu"]

The Composite Component wizard opens, containing the selected snippet in its Implementation Section panel.

image::kb/docs/web/comp-component.png[title="Composite Component wizard displays containing the selected code snippet"]
...
image::kb/docs/web/comp-component-editor.png[title="Component tag is automatically inserted into your page"]
...
image::kb/docs/web/template-wizard.png[title="Create a Facelets template using the Facelets Template wizard"]
...
image::kb/docs/web/jsf-entity-wizard.png[title="Specify the locations of the files that will be generated"]
...
image::kb/docs/web/jsf-form-from-entity.png[title="Use the Form from Entity dialog to generate a JSF Form using Entity data"]
...
image::kb/docs/web/jsf-data-table-from-entity.png[title="Use the Data Table from Entity dialog to generate a JSF data table from entity data"]
...
image::kb/docs/web/palette.png[title="Use the IDE's Palette to drag and drop common JSF components onto a Facelets page"]
...
image::kb/docs/web/insert-code.png[title="In the editor, press Alt-Insert (Ctrl-I on Mac) to invoke a list of JSF-specific components"]

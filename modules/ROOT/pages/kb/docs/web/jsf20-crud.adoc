...
image::./consultants-list-small.png[role="left", xref="image$./consultants-list.png"]
...
image::./view-data-table-small.png[role="left", xref="image$./view-data-table.png"]
...
image::./localized-messages-small.png[role="left", xref="image$./localized-messages.png"]
...
image::./gf-admin-console-sm.png[role="left", xref="image$./gf-admin-console-lg.png"]

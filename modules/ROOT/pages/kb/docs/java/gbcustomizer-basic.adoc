...
image::./layout1-small.png[role="left", xref="image$./layout1.png"]
...
image::./tfieldsresized-small.png[role="left", xref="image$./tfieldsresized.png"]
...
image::./horizontalset-small.png[role="left", xref="image$./horizontalset.png"]
...
image::./comboanchored-small.png[role="left", xref="image$./comboanchored.png"]
...
image::./contactsbasicfinal-small.png[role="left", xref="image$./contactsbasicfinal.png"]

...
image::./generator-plugin.png[title="Load Generator plugins in Plugins manager"]
...
image::./jmeter-externaledit.png[title="JMeter load testing script in project structure"] 
...
image::./jmeter-output.png[title="Output window showing Load Generator status"]
...
image::./jmeter-services2.png[title="Services window showing status of Load Generator"]

...
image::./cmd_small.png[role="left", xref="image$./cmd.png"]
...
image::./new_javase_prj_small.png[role="left", xref="image$./new_javase_prj.png"]
...
image::./enable_native_pkg_small.png[role="left", xref="image$./enable_native_pkg.png"]
...
image::./output_small.png[role="left", xref="image$./output.png"]
...
image::./output_se_exe_small.png[role="left", xref="image$./output_se_exe.png"]
...
image::./new_javafx_prj_small.png[role="left", xref="image$./new_javafx_prj.png"]
...
image::./brickbreaker_small.png[role="left", xref="image$./brickbreaker.png"]
...
image::./enable_native_pkg_fx_small.png[role="left", xref="image$./enable_native_pkg_fx.png"]
...
image::./output_fx_msi_small.png[role="left", xref="image$./output_fx_msi.png"]

...
You will also make use of this icon, which you can right-click here and download: image:tutorials/projectextensions_webPagesBadge.gif[]
...
image::tutorials/cc_72_deps-1.png[]
...
image:tutorials/projectextensions_webPagesBadge.gif[]
...
image::tutorials/cc_72_result-3.png[]
...
image::tutorials/cc_72_result-4.png[]

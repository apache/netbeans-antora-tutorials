...
image::kb/docs/web/add-weblogic-server2.png[title="Add Server wizard"]
...
image::kb/docs/web/weblogic-services-window1.png[title="WebLogic Server in the Services window"]  
...
image::kb/docs/web/admin-console1.png[title="Oracle WebLogic Server Admin Console"]
...
image::kb/docs/web/weblogic-properties-enablejpa.png[title="Domain tab in Servers manager"]
...
image::kb/docs/web/admin-console-jpa.png[title="JPA tab in Oracle WebLogic Server Admin Console"]
...
image::kb/docs/web/new-project-ee6.png[title="Weblogic selected in New Project wizard"]
...
image::kb/docs/web/projectwizard-serverlib.png[title="Frameworks panel New Project wizard"]
...
image::kb/docs/web/wl-projects-window1.png[title="weblogic.xml selected in Projects window"]
...
image::kb/docs/web/install-libraries-dialog.png[title="Resolve Missing Server Library dialog"]
...
image::kb/docs/web/create-db.png[title="Create Database dialog box"]
...
image::kb/docs/web/services-window2.png[title="Sample database node in in the Services window"]
...
image::kb/docs/web/new-persistence-eclipselink1.png[title="New Persistence Unit wizard"]
...
image::kb/docs/web/browser-welcome.png[title="Welcome page in browser"]
...
image::kb/docs/web/adminconsole-deployments.png[title="Deployments table in WebLogic Server Admin Console"]
...
image::kb/docs/web/admin-console-deployments.png[title="Deployments table in WebLogic Server Admin Console"]
...
image::kb/docs/web/weblogic-services-window2.png[title="WebLogic Server applications and resources in the Services window"]

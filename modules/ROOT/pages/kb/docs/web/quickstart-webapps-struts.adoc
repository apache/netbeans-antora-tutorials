...
image::kb/docs/web/workflow.png[title="Struts workflow"]
...
image::kb/docs/web/new-project-wizard.png[title="Struts option displays in Frameworks panel of New Web Application wizard"]
...
image::kb/docs/web/proj-window-init.png[title="Projects window displays MyStrutsApp project"]
...
image::kb/docs/web/code-completion.png[title="Code completion and Javadoc are supplied for Struts tags"]
...
image::kb/docs/web/insert-table.png[title="The Palette provides dialogs for easy-to-use code templates"] 
...
image::kb/docs/web/navigation-support.png[title="Navigation support is provided in struts-config.xml"]
...
image::kb/docs/web/create-accessors.png[title="Insert Code menu displays when pressing Ctrl-I in Source Editor"]
...
image::kb/docs/web/new-struts-action.png[title="New Struts Action wizard"]
...
image::kb/docs/web/add-forward.png[title="Right-click and choose Struts > Add Forward"]
...
image::kb/docs/web/add-forward-dialog.png[title="Add Forward dialog creates a forward entry in struts-config.xml"] 
...
image::kb/docs/web/welcome-files.png[title="Graphical editor for the application's deployment descriptor"] 
...
image::kb/docs/web/login-form.png[title="Form contains data that will fail validation"] 

When you click Login, the login form page redisplays, containing an error message: 

image::kb/docs/web/login-form-error.png[title="Form redisplays with error message"] 

Try entering data that should pass validation. Upon clicking Login, you are presented with the success page: 

image::kb/docs/web/success-page.png[title="Success page displays showing input data"]

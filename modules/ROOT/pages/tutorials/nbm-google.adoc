...
image::./googlebar_google-result.png[]
...
image::./googlebar_new-project-0.png[]
...
image::./googlebar_new-project-1.png[] 
...
image::./googlebar_new-project-2.png[]
...
image::./googlebar_new-project-3.png[]
...
image::./googlebar_new-action-0.png[]
...
image::./googlebar_new-action-1.png[]
...
image::./googlebar_new-action-2.png[]
...
image::./googlebar_new-action-3.png[]
...
image::./googlebar_google.png[]

* 24x24: 

image::./googlebar_google24.png[]
...
image::./googlebar_new-action-4.png[]

[start=5]
1. Click btn:[Finish]. The module source structure is now as follows: 

image::./googlebar_new-action-5.png[]
...
image::./googlebar_result-1.png[]

Close the target platform instance:

image::./googlebar_result-2.png[]
...
image::./googlebar_new-toolbar-2.png[]
...
image::./googlebar_new-toolbar-3.png[]
...
image::./googlebar_new-toolbar-4.png[]
...
image::./googlebar_new-toolbar-5.png[]
...
image::./googlebar_new-toolbar-6.png[]

The matching dependency is shown:

image::./googlebar_new-toolbar-7.png[]

...
image::./01_gb_ui-small.png[role="left", xref="image$./01_gb_ui.png"]
...
image::./02_add_panels_1-small.png[role="left", xref="image$./02_add_panels_1.png"]
...
image::./02_add_panels_2-small.png[role="left", xref="image$./02_add_panels_2.png"]
...
image::./02_add_panels_3-small.png[role="left", xref="image$./02_add_panels_3.png"]
...
image::./02_add_panels_4-small.png[role="left", xref="image$./02_add_panels_4.png"]
...
image::./02_add_panels_5-small.png[role="left", xref="image$./02_add_panels_5.png"]
...
image::./02_add_borders-small.png[role="left", xref="image$./02_add_borders.png"]
...
image::./06_align_1-small.png[role="left", xref="image$./06_align_1.png"]
...
image::./06_align_2-small.png[role="left", xref="image$./06_align_2.png"]
...
image::./06_align_3-small.png[role="left", xref="image$./06_align_3.png"]
...
image::./06_align_4-small.png[role="left", xref="image$./06_align_4.png"]
...
image::./buttons_1-small.png[role="left", xref="image$./buttons_1.png"]
...
image::./buttons_2-small.png[role="left", xref="image$./buttons_2.png"]
...
image::./buttons_3-small.png[role="left", xref="image$./buttons_3.png"]
...
image::./buttons_4-small.png[role="left", xref="image$./buttons_4.png"]
...
image::./buttons_5-small.png[role="left", xref="image$./buttons_5.png"]
...
image::./buttons_6-small.png[role="left", xref="image$./buttons_6.png"]
...
image::./07_indent_1-small.png[role="left", xref="image$./07_indent_1.png"]
...
image::./07_indent_3-small.png[role="left", xref="image$./07_indent_3.png"]
...
image::./07_group-small.png[role="left", xref="image$./07_group.png"]
...
image::./08_cancel-small.png[role="left", xref="image$./08_cancel.png"]
...
image::./08_same_size-small.png[role="left", xref="image$./08_same_size.png"]
...
image::./08_preview_gui-small.png[role="left", xref="image$./08_preview_gui.png"]

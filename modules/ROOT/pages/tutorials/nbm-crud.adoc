...
image::tutorials/crud_70_dbmanager-99c.png[]
...
image::tutorials/crud_72_app-1.png[]
...
image::tutorials/crud_72_app-2.png[]
...
image::tutorials/crud_72_app-3.png[]
...
image::tutorials/crud_72_db-2.png[]
...
image::tutorials/crud_72_db-4.png[]
...
image::tutorials/crud_72_db-5.png[]
...
image::tutorials/crud_72_db-6.png[]
...
image::tutorials/crud_72_db-7.png[]
...
image::tutorials/crud_72_db-8.png[]
...
image::tutorials/crud_72_wrap-1.png[]
...
image::tutorials/crud_72_wrap-2.png[]

Click Next.


image::tutorials/crud_72_wrap-3.png[]

Name the project  ``CustomerLibrary`` , as shown above. Then click Next.


image::tutorials/crud_72_wrap-4.png[]
...
image::tutorials/crud_72_db-9.png[]
...
image::tutorials/crud_72_wrap-5.png[]
...
To use an embedded Java DB database, instead of the external Java DB database used in this tutorial,  xref:front::blogs/geertjan/embedded_database_for_netbeans_platform.adoc[read this article].
...
image::tutorials/crud_72_wrap-6.png[]
...
image::tutorials/crud_72_proto-1.png[]
...
image::tutorials/crud_72_proto-2.png[]
...
image::tutorials/crud_72_result-2.png[]
...
image::tutorials/crud_72_result-1.png[]
...
image::tutorials/crud_72_update-1.png[]
...
image::tutorials/crud_72_update-2.png[]
...
image::tutorials/crud_72_update-3.png[]

However, note what happens when you switch the focus to the editor window:


image::tutorials/crud_72_update-4.png[]
...
image::tutorials/crud_72_update-5.png[]
...
image::tutorials/crud_70_dbmanager-99d.png[]
...
image::tutorials/crud_71_db-manager-96.png[]
...
For information on embedding a database in a NetBeans Platform application, see xref:front::blogs/geertjan/embedded_database_for_netbeans_platform.adoc[Embedded Database for NetBeans Platform CRUD Tutorial ].

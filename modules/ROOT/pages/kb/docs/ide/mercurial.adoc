...
image::./options-dialog-small.png[role="left", link="images/options-dialog.png"]
...
image::./clone-repository-small.png[role="left", link="images/clone-repository.png"]
...
image::./clone-username-small.png[role="left", link="images/clone-username.png"]
...
image::./clone-push-small.png[role="left", link="images/clone-push.png"]
...
image::./clone-destination-small.png[role="left", link="images/clone-destination.png"]
...
image::./repositoryrootpath.png[role="left", link="images/repositoryrootpath.png"]
...
image::./output-small.png[role="left", link="images/output.png"]
...
image::./status-small.png[role="left", link="images/status.png"]
...
image::./commit-dialog-small.png[role="left", link="images/commit-dialog.png"]
...
image::./left-ui-small.png[role="left", link="images/left-ui.png"]
...
image::./right-ui-small.png[role="left", link="images/right-ui.png"]
...
|* *Revert Modifications*: Opens the Revert Modifications dialog which you can use to specify parameters for reverting any local changes to revisions maintained in the repository.
 |[.feature]
--
image:./search-rev-small.png[role="left", link="images/search-rev.png"]
--
...
image::./mercurial-merge-small.png[role="left", link="images/mercurial-merge.png"]
...
image::./mercurial-commit-dialog-small.png[role="left", link="images/mercurial-commit-dialog.png"]

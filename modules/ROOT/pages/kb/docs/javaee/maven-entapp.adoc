...
image::kb/docs/javaee/maven-newproject1.png[title="Maven Enterprise Application project type in the New Project wizard"]
...
image::kb/docs/javaee/maven-newproject2.png[title="Maven Project details in the New Project wizard"]
...
image::kb/docs/javaee/maven-projectswindow2.png[title="Projects window showing generated projects"]
...
image::kb/docs/javaee/priming-build.png[title="The Maven icon in the status bar enables you to run a priming build"] 
...
image::kb/docs/javaee/maven-persistenceunit.png[title="New Persistence Unit wizard"]
...
image::kb/docs/javaee/maven-messagedestination.png[title="Add Message Destination dialog"]



. Confirm that the project destination is correct. Click Next.

image::kb/docs/javaee/maven-newmdb.png[title="New Message-Driven Bean wizard"]
...
image::kb/docs/javaee/maven-sessionwizard.png[title="Session Beans for Entity Classes wizard"]
...
image::kb/docs/javaee/maven-callbean.png[title="Call Enterprise Bean dialog"]
...
image::kb/docs/javaee/maven-searchdepend1.png[title="Fix All Imports dialog"]
...
image::kb/docs/javaee/maven-searchdependencies.png[title="Hint in editor to search repositories for dependencies"]
...
image::kb/docs/javaee/maven-searchdepend2.png[title="Search in Maven Repositories dialog"]
...
image::kb/docs/javaee/maven-jms-imports.png[title="Fix All Imports dialog"]
...
image::kb/docs/javaee/maven-earpom.png[title="pom.xml of EAR project"]
...
image::kb/docs/javaee/maven-webpom.png[title="pom.xml of Web App project"]
...
image::kb/docs/javaee/maven-webpomgraph.png[title="Graph of dependencies"]
...
image::kb/docs/javaee/maven-addscope-javaee.png[title="code completion for scope element in POM"]
...
image::kb/docs/javaee/maven-reactor1.png[title="Output window showing Reactor build order"]

The results of the build are also displayed in the Output window.

image::kb/docs/javaee/maven-reactor2.png[title="Output window showing Reactor build status"]
...
image::kb/docs/javaee/maven-earfileswindow1.png[title="Files window showing EAR archive"]
...
image::kb/docs/javaee/maven-browser1.png[title="ListNews page open in the browser"]
...
image::kb/docs/javaee/maven-browser2.png[title="PostMessage page open in the browser"]
...
NOTE:  For more about installing Subversion, see the section on xref:kb/docs/ide/subversion.adoc#settingUp[+Setting up Subversion+] in the xref:kb/docs/ide/subversion.adoc[+Guide to Subversion in NetBeans IDE+].

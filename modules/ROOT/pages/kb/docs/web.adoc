...
** xref:kb/docs/websvc/flower_overview.adoc[+Part 1: Overview+]
** xref:kb/docs/websvc/flower_ws.adoc[+Part 2: Creating the Web Service+]
** xref:kb/docs/websvc/flower-code-ws.adoc[+Part 3: Coding and Testing the Web Service+]
** xref:kb/docs/websvc/flower_wsdl_schema.adoc[+Part 4: Modifying the Schema and WSDL Files+]
** xref:kb/docs/websvc/flower_swing.adoc[+Part 5: Creating the Swing Client+]
...
* xref:wiki::wiki/TransformingSOAPMessagesWithXSLT.adoc[+Transforming SOAP Messages with XSLT+], by Siegfried Bolz
...
* xref:wiki::wiki/SOAPclientForOpenCalais.adoc[+A SOAP Client for Open Calais+], by Amit Kumar Saha
...
* xref:wiki::wiki/NetBeansUserFAQ.adoc#section-NetBeansUserFAQ-WebServicesDevelopment[+Web Service Development FAQs+]
...
* xref:front::blogs/geertjan/index.adoc[Geertjan Wielenga: NetBeans IDE Platform]

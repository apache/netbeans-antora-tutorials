...
image::./plugins-small.png[role="left", link="images/plugins.png"]
...
image::./jpmanager-small.png[role="left", link="images/jpmanager.png"]
...
image::./addjp-small.png[role="left", link="images/addjp.png"]
...
image::./jpremote-small.png[role="left", link="images/jpremote.png"]
...
image::./wizard-small.png[role="left", link="images/wizard.png"]
...
image::./jdk8-small.png[role="left", link="images/jdk8.png"]
...
image::./jdk8registered-small.png[role="left", link="images/jdk8registered.png"]
...
image::./prj-jdk8-small.png[role="left", link="images/prj-jdk8.png"]
...
image::./prj-source-jdk8-small.png[role="left", link="images/prj-source-jdk8.png"]
...
image::./prj-jdk8-profile-small.png[role="left", link="images/prj-jdk8-profile.png"]
...
image::./config-runtime-small.png[role="left", link="images/config-runtime.png"]
...
image::./run-remote-small.png[role="left", link="images/run-remote.png"]
...
image::./switch-config-small.png[role="left", link="images/switch-config.png"]

...
image:./mockup-index-small.png[role="left", xref="image$./mockup-index.png"]
...
image:./mockup-category-small.png[role="left", xref="image$./mockup-category.png"]
...
image:./mockup-cart-small.png[role="left", xref="image$./mockup-cart.png"]
...
image::./mockup-checkout-small.png[role="left", xref="image$./mockup-checkout.png"]
...
image::./mockup-confirmation-small.png[role="left", xref="image$./mockup-confirmation.png"]

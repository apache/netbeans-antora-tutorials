...
image::./initialize-git-repo-small.png[role="left", xref="image$./initialize-git-repo.png"]
...
image::./clone-wizard-small.png[role="left", xref="image$./clone-wizard.png"]
...
image::./github-repo-small.png[role="left", xref="image$./github-repo.png"]
...
image::./github-branches-small.png[role="left", xref="image$./github-branches.png"]
...
image::./github-destination-small.png[role="left", xref="image$./github-destination.png"]
...
image::./versioning-view-small.png[role="left", xref="image$./versioning-view.png"]
...
image::./versioning-right-click-small.png[role="left", xref="image$./versioning-right-click.png"]
...
image::./commit-small.png[role="left", xref="image$./commit.png"]
...
image::./create-branch-small.png[role="left", xref="image$./create-branch.png"]
...
image::./branch-added-small.png[role="left", xref="image$./branch-added.png"]
...
image::./chkout-rev-small.png[role="left", xref="image$./chkout-rev.png"]
...
image::./chkout-path-small.png[role="left", xref="image$./chkout-path.png"]
...
image::./merge-small.png[role="left", xref="image$./merge.png"]
...
image::./fetch-small.png[role="left", xref="image$./fetch.png"]
...
image::./pull-small.png[role="left", xref="image$./pull.png"]
...
image::./push-small.png[role="left", xref="image$./push.png"]

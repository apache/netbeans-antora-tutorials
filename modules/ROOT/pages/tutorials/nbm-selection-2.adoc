...
image::tutorials/selection-2_explorer1.png[]
...
image::tutorials/selection-2_result1.png[]
...
image::tutorials/selection-2_result2.png[]
...
image::tutorials/selection-2_result6.png[]

* *MenuView* - a `JButton` that pops up a menu of a Node and its children

image::tutorials/selection-2_result7.png[]
...
image::tutorials/selection-2_multiselect1.png[]

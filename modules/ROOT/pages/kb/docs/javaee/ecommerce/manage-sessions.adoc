...
image::./session-variable-set.png[role="left", xref="image$./session-variable-set.png"]
...
image::./variables-win-session.png[role="left", xref="image$./variables-win-session.png"]
...
image::./variables-win-session-cart.png[role="left", xref="image$./variables-win-session-cart.png"]
...
image::./variables-window-add-item.png[role="left", xref="image$./variables-window-add-item.png"]
...
image::./variables-window-number-of-items.png[role="left", xref="image$./variables-window-number-of-items.png"]
...
image::./http-monitor-add-to-cart.png[role="left", xref="image$./http-monitor-add-to-cart.png"]
...
image::./gf-server-output.png[role="left", xref="image$./gf-server-output.png"]

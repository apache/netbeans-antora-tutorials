...
image::kb/docs/java/01_gb_ui-small.png[role="left", xref="image$./01_gb_ui.png"]
...
image::kb/docs/java/02_add_panels_1-small.png[role="left", xref="image$./02_add_panels_1.png"]
...
image::kb/docs/java/02_add_panels_2-small.png[role="left", xref="image$./02_add_panels_2.png"]
...
image::kb/docs/java/02_add_panels_3-small.png[role="left", xref="image$./02_add_panels_3.png"]
...
image::kb/docs/java/02_add_panels_4-small.png[role="left", xref="image$./02_add_panels_4.png"]
...
image::kb/docs/java/02_add_panels_5-small.png[role="left", xref="image$./02_add_panels_5.png"]
...
image::kb/docs/java/02_add_borders-small.png[role="left", xref="image$./02_add_borders.png"]
...
image::kb/docs/java/03_indy_add_1.png[]
...
image::kb/docs/java/03_indy_add_2.png[]
...
image::kb/docs/java/03_indy_add_3.png[]
...
image::kb/docs/java/04_multi-add_1.png[]
...
image::kb/docs/java/04_multi-add_2.png[]
...
image::kb/docs/java/05_insert_1.png[]

image::kb/docs/java/05_insert_2.png[]
...
2. Click the Align Right in Column button (image:kb/docs/java/align_r.png[]) in the toolbar. Alternately, you can right-click either one and choose Align > Right in Column from the pop-up menu.
...
image::kb/docs/java/06_align_1-small.png[role="left", xref="image$./06_align_1.png"]
...
image::kb/docs/java/06_align_2-small.png[role="left", xref="image$./06_align_2.png"]
...
image::kb/docs/java/06_align_3-small.png[role="left", xref="image$./06_align_3.png"]
...
image::kb/docs/java/06_align_4-small.png[role="left", xref="image$./06_align_4.png"]
...
image::kb/docs/java/buttons_1-small.png[role="left", xref="image$./buttons_1.png"]
...
image::kb/docs/java/buttons_2-small.png[role="left", xref="image$./buttons_2.png"]
...
image::kb/docs/java/buttons_3-small.png[role="left", xref="image$./buttons_3.png"]
...
image::kb/docs/java/buttons_4-small.png[role="left", xref="image$./buttons_4.png"]
...
image::kb/docs/java/buttons_5-small.png[role="left", xref="image$./buttons_5.png"]
...
image::kb/docs/java/buttons_6-small.png[role="left", xref="image$./buttons_6.png"]
...
image::kb/docs/java/07_indent_1-small.png[role="left", xref="image$./07_indent_1.png"]
...
image::kb/docs/java/07_indent_3-small.png[role="left", xref="image$./07_indent_3.png"]
...
image::kb/docs/java/07_group-small.png[role="left", xref="image$./07_group.png"]
...
image::kb/docs/java/08_cancel-small.png[role="left", xref="image$./08_cancel.png"]
...
image::kb/docs/java/08_same_size-small.png[role="left", xref="image$./08_same_size.png"]
...
Now that you have successfully built the ContactEditor GUI, you can try your interface to see the results. You can preview your form as you work by clicking the Preview Form button (image:kb/docs/java/test_form.png[]) in the GUI Builder's toolbar. The form opens in its own window, allowing you to test it prior to building and running.

[.feature]
--

image::kb/docs/java/08_preview_gui-small.png[role="left", xref="image$./08_preview_gui.png"]

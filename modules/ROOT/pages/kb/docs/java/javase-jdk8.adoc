...
image::./jdk8_small.png[role="left", xref="image$./jdk8.png"]
...
image::./jdk8registered_small.png[role="left", xref="image$./jdk8registered.png"]
...
image::./prj_jdk8_small.png[role="left", xref="image$./prj_jdk8.png"]
...
image::./prj_source_jdk8_small.png[role="left", xref="image$./prj_source_jdk8.png"]
...
image::./prj_src_profile_small.png[role="left", xref="image$./prj_src_profile.png"]
...
image::./profile_small.png[role="left", xref="image$./profile.png"]
...
image::./lambda_small.png[role="left", xref="image$./lambda.png"]
...
image::./lambda_clicked_small.png[role="left", xref="image$./lambda_clicked.png"]
...
image::./lambda_converted_small.png[role="left", xref="image$./lambda_converted.png"]
...
image::./inspect_small.png[role="left", xref="image$./inspect.png"]
...
image::./lambda_inspection_small.png[role="left", xref="image$./lambda_inspection.png"]
...
image::./lambda_transform_small.png[role="left", xref="image$./lambda_transform.png"]

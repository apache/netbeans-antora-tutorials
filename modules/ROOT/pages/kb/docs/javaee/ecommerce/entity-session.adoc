...
image::kb/docs/javaee/ecommerce/java-ee-container.png[title="As a Java EE container, GlassFish v3 contains web and EJB containers, and EclipseLink, the persistence provider"]
...
image::kb/docs/javaee/ecommerce/entity-from-database.png[title="Choose an available data source to have the IDE read in database tables"]
...
image::kb/docs/javaee/ecommerce/entity-classes-68.png[title="NetBeans 6.8 - Entity Classes from Database wizard, Step 3: Entity Classes"]
...
image::kb/docs/javaee/ecommerce/create-pu.png[title="Use the Create Persistence Unit dialog to generate a persistence.xml file"] 
...
image::kb/docs/javaee/ecommerce/entity-classes-69.png[title="NetBeans 6.9 - Entity Classes from Database wizard, Step 3: Entity Classes"]
...
image::kb/docs/javaee/ecommerce/embedded-id.png[title="Press Ctrl-Space to invoke the API documentation"]
...
image::kb/docs/javaee/ecommerce/persistence-unit.png[title="Design view of the AffableBeanPU persistence unit"]
...
image::kb/docs/javaee/ecommerce/session-beans-for-entity-classes.png[title="Select Session Beans for Entity Classes to generate a session facade for your persistence model"]
...
image::kb/docs/javaee/ecommerce/generated-session-beans.png[title="Specify the location of the new session beans, and whether to create interfaces"] 
...
|image:kb/docs/javaee/ecommerce/projects-window-session-beans.png[title="Examine new session beans in the Projects window"] |image:kb/docs/javaee/ecommerce/projects-window-session-beans-69.png[title="Examine new session beans in the Projects window"] 
|===
...
image::kb/docs/javaee/ecommerce/method-signature.png[title="Over your mouse over the method while holding down the Ctrl key to view its signature"] 
...
image::kb/docs/javaee/ecommerce/override.png[title="Use the IDE's hint to add the @Overrides annotation to the method"] 
...
image::kb/docs/javaee/ecommerce/commented-out.png[title="Press Ctrl-/ to comment out a code snippet in the editor"]
...
[start=11]
. Run the project. Click the Run Project ( image:kb/docs/javaee/ecommerce/run-project-btn.png[] ) button. The project's index page opens in the browser, and you see that all four category names and images display. 

image::kb/docs/javaee/ecommerce/index-page.png[title="Verify that the index page is able to retrieve category details"]
...
image::kb/docs/javaee/ecommerce/comment-out-sql.png[title="Comment out JSTL <sql> statements in the category page"]
...
[start=3]
. Run the project to examine the current state of the category page. Click the Run Project ( image:kb/docs/javaee/ecommerce/run-project-btn.png[] ) button. When the project's index page opens in the browser, click any of the four categories. The category buttons in the left column display and function as expected. 

image::kb/docs/javaee/ecommerce/category-page-left-column.png[title="Category buttons in left column display and function as expected"]
...
[start=4]
. Click the badge ( image:kb/docs/javaee/ecommerce/editor-badge.png[] ) in the left margin to use the editor's hint to declare `selectedCategory` as a local variable within the `doGet` method. 

image::kb/docs/javaee/ecommerce/local-variable.png[title="Use editor hints to declare local variables"] 
...
image::kb/docs/javaee/ecommerce/category-page-selected-category.png[title="Selected category name displays in the category page"]
...
image::kb/docs/javaee/ecommerce/local-variable2.png[title="Use editor hints to declare local variables"]
...
image::kb/docs/javaee/ecommerce/category-page-product-table.png[title="Product table displays products of a given category"]

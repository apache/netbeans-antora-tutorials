...
|NetBeans IDE (including C/C++/Fortran support) |xref:front::download/index.adoc[version 7.4 or 8.0 with NetBeans C/C{pp} plugin] 
...
image::kb/docs/cnd/c-unit-new-project.png[]
...
image::kb/docs/cnd/c-unit-mainc-initial.png[]
...
image::kb/docs/cnd/c-unit-mainc-edited.png[]
...
image::kb/docs/cnd/c-unit-output-factorial.png[]
...
image::kb/docs/cnd/c-unit-create-test.png[]
...
image::kb/docs/cnd/c-unit-includes.png[]
...
image::kb/docs/cnd/c-unit-run-test-orig.png[]
...
image::kb/docs/cnd/c-unit-run-test-pass.png[]
...
image::kb/docs/cnd/c-unit-new-cunit-test.png[]

[start=2]
. Name the test My CUnit Test and the test file name `mycunittest` and click Finish.

image::kb/docs/cnd/c-unit-create-mycunittest.png[]
...
image::kb/docs/cnd/c-unit-run-mytest1.png[]
...
image::kb/docs/cnd/c-unit-test-fail-annotation.png[]
...
image::kb/docs/cnd/c-unit-debug-icons.png[]
...
image::kb/docs/cnd/c-unit-mainc-new-simple-test.png[]

[start=2]
. In the wizard's Select Elements window, click the checkbox for the  ``main``  function, then click Next.

image::kb/docs/cnd/c-unit-mainc-new-simple-test-select.png[]
...
image::kb/docs/cnd/c-unit-mainc-new-simple-test-folder.png[]
...
image::kb/docs/cnd/c-unit-mainc-new-simple-test-code.png[]
...
image::kb/docs/cnd/c-unit-simpletest-results.png[]
...
You can add support for your favorite C/C++ test framework by creating a NetBeans module. See the NetBeans developer's xref:wiki::wiki/CND69UnitTestsPluginTutotial.adoc[C/C{pp} Unit Test Plugin Tutorial] on the NetBeans wiki.

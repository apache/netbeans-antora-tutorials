...
* For more information on configuring the IDE to work with JavaDB, see the xref:kb/docs/ide/java-db.adoc[Working with the Java DB (Derby) Database] tutorial.
...
image::kb/docs/web/run-sql-script.png[title="Open SQL files in the IDE's editor"]


. Make sure that the `consult` database is selected in the Connection drop-down list in the SQL editor toolbar, then click the Run SQL ( images:./run-sql-btn.png[] ) button.

When you click Run SQL, the following output appears in the Output window.

image::kb/docs/web/run-sql-output.png[title="Output window provides information on SQL execution"]
...
image::kb/docs/web/services-window-tables.png[title="Services window displays database connections, tables, table columns, indexes, and foreign keys"]
...
image::kb/docs/web/diagram_consult.png[title="Entity-relationship diagram of consult database"]
...
image::kb/docs/web/create-datasource.png[title="Specify a JNDI name and database connection to create a datasource"]
...
image::kb/docs/web/new-entities-wizard.png[]
...
image::kb/docs/web/projects-window-entities.png[title="screenshot of Projects window showing generated entity classes"]
...
image::kb/docs/web/newjsf-wizard.png[title="New JSF Pages from Entity Classes wizard displays all entity classes contained in project"] 
...
image::kb/docs/web/newjsf-wizard2.png[title="Specify package and folder names for generated files"]
...
image::kb/docs/web/customize-template.png[title="Customize templates for files generated by the wizard"] 
...
image::kb/docs/web/projects-jsfpages.png[title="Facelets pages for each entity class are generated by the wizard"]
...
image::kb/docs/web/projects-generated-classes70.png[title="screenshot of Source Packages directory in Projects window showing classes generated by wizard"]
...
1. To run the project, either right-click the project node in the Projects window and choose Run, or click the Run Project ( images:./run-project-btn.png[] ) button in the main toolbar.
...
image::kb/docs/web/welcome-page-links.png[title="Links to display database contents for each table"]
...
image::kb/docs/web/empty-consultants-list.png[title="Consultants table is currently empty"] 
...
image::kb/docs/web/run-sql-insert.png[title="Open the script in the IDE's SQL editor"]

Either right-click in the editor and choose Run Statement, or click the Run SQL ( images:./run-sql-btn.png[] ) button. You can see the result of the script execution in the Output window.
...
image::kb/docs/web/consultants-list-small.png[role="left", xref="image$./consultants-list.png"]
...
image::kb/docs/web/view-data.png[title="Choose View Data from the right-click menu of database tables"]
...
image::kb/docs/web/view-data-table-small.png[role="left", xref="image$./view-data-table.png"]

--

Double-click inside table cells to perform inline modifications to data. Click the Commit Records ( images:./commit-records-icon.png[] ) icon to commit changes to the database.

The graphical view provides much more functionality. See xref:kb/docs/ide/database-improvements-screencast.adoc[Database Support in NetBeans IDE] for more information.
...
image::kb/docs/web/go-to-file.png[title="Use the Go to File dialog to quickly open project files"]
...
image::kb/docs/web/doc-popup.png[title="Press Ctrl-Space to invoke a documentation popup on Facelets tags"]
...
image::kb/docs/web/localized-messages-small.png[role="left", xref="image$./localized-messages.png"]
...
image::kb/docs/web/code-completion-managed-bean.png[title="Code completion is provided for JSF managed beans"]
...
image::kb/docs/web/code-completion-properties.png[title="Code completion is provided for class methods"]
...
image::kb/docs/web/editor-navigation.png[title="Use editor navigation to quickly navigate source code"]
...
image::kb/docs/web/create-new-consultant.png[title="Enter sample data into the form"] 
...
image::kb/docs/web/consultant-fk.png[title="Examine foreign key attributes in the Services window"]
...
image::kb/docs/web/code-completion-returned-object.png[title="Code completion displays returned classes for methods"]
...
image::kb/docs/web/documentation-select-item.png[title="Press Ctrl-Space to invoke documentation support"]

Click the web browser ( images:./web-browser-icon.png[] ) icon in the documentation window to open the Javadoc in an external web browser.
...
image::kb/docs/web/method-signature.png[title="View pop-ups of method signatures in the editor"] 
...
image::kb/docs/web/drop-down.png[title="StatusId drop-down displays items according to ConsultantStatus entity's toString() method"]
...
image::kb/docs/web/gf-admin-console-sm.png[role="left", xref="image$./gf-admin-console-lg.png"]
...
image::kb/docs/web/gf-new-jdbc-pool1.png[title="New JDBC Connection Pool pane in the GlassFish Admin Console"]
...
image::kb/docs/web/gf-new-jdbc-pool2.png[title="New JDBC Connection Pool panel in the GlassFish Admin Console"]
...
image::kb/docs/web/gf-new-jdbc-resource.png[title="New JDBC Resource pane in the GlassFish Admin Console"]
...
image::kb/docs/web/gf-services-jdbc-resources.png[title="JDBC Resources displayed in the Services window of the IDE"]

...
image::./team-plugin.png[title="Team Server plugin selected in Plugins manager"]
...
image::./add-team-server.png[title="Add Team Server dialog"]
...
image::./services-window.png[title="Team Servers node in Services window"]
...
image::./user-login.png[title="Add Team Server dialog"]
...
image::./get-sources.png[title="Get Sources from Team Server dialog"]


. In the Browse Team Projects dialog, type a search term and then click Search.

image::./browse-projects.png[title="Browse Team Projects dialog"]
...
image::./folder-to-get.png[title="Browse Repository Folders dialog"]

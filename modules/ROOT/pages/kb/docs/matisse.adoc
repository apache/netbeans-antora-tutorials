...
* xref:wiki::wiki/UsingNetbeansMatisseAndEclipseInParallel.adoc[Using Netbeans Matisse And Eclipse In Parallel]

== Other Resources

* link:http://download.oracle.com/javafx/[+JavaFX Documentation+]
* xref:wiki::wiki/JavaFX.adoc[NetBeans wiki page on JavaFX support]
...
* xref:wiki::wiki/NetBeansUserFAQ.adoc#GUI_Editor_.28Matisse.29[+GUI Editor FAQs+]

...
image::kb/docs/web/frameworks-window.png[title="Spring Web MVC displayed in the Frameworks panel"]
...
image::kb/docs/web/spring-configuration.png[title="Specify the name and mapping of the Spring Dispatcher servlet under the Configuration tab"]
...
image::kb/docs/web/spring-libraries.png[title="Spring JARs are listed under the project's Libraries node"]
...
1. Click the New File ( images:./new-file-btn.png[] ) button in the IDE's toolbar. (Alternatively, press Ctrl-N; ⌘-N on Mac.)
...
image::kb/docs/web/simple-form-controller.png[title="NetBeans IDE provides templates for various Spring artifacts"] 
...
image::kb/docs/web/comment-out.png[title="Highlight code snippets, then press Ctrl-/ to toggle comments"] 
...
image::kb/docs/web/set-command-class.png[title="An error badge displays for setCommandClass()"]
...
image::kb/docs/web/generate-code.png[title="The Generate Code popup menu enables you to set accessor methods"]
...
image::kb/docs/web/fix-imports70.png[title="Press Ctrl-Shift-I to fix imports in your file"]
...
image::kb/docs/web/code-completion.png[title="Code completion invoked when pressing Ctrl-Space"]
...
image::kb/docs/web/name-view.png[title="nameView is displayed in a browser"] 

Enter your name in the text field and click enter. The `helloView` displays with a greeting message: 

image::kb/docs/web/hello-view.png[title="helloView is displayed in a browser"]

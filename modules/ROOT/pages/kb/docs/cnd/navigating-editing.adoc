...
See the xref:front::community/releases/80/install.adoc[NetBeans IDE 8.0 Installation Instructions] and xref:front::community/releases/80/cpp-setup-instructions.adoc[Configuring the NetBeans IDE for C/C{pp}/Fortran]

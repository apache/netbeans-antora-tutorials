...
[.feature]
--
image:./numberslider-small.png[role="left", link="images/numberslider.png"]
--
...
image::./numberslider2-small.png[role="left", link="images/numberslider2.png"]
...
image::./slider-textfield-small.png[role="left", link="images/slider-textfield.png"]
...
image::./bind-dialog-small.png[role="left", link="images/bind-dialog.png"]
...
image::./entity-wizard1-small.png[role="left", link="images/entity-wizard1.png"]
...
image::./entity-wizard2-small.png[role="left", link="images/entity-wizard2.png"]
...
image::./bind-dialog-table-small.png[role="left", link="images/bind-dialog-table.png"]
...
image::./source-selected-small.png[role="left", link="images/source-selected.png"]
...
image::./jlist-binding-small.png[role="left", link="images/jlist-binding.png"]
...
image::./combo-binding-small.png[role="left", link="images/combo-binding.png"]
...
image::./custom-small.png[role="left", link="images/custom.png"]

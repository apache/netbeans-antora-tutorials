...
|link:https://web.archive.org/web/20170713202117/https://netbeans.org/projects/samples/downloads/download/Samples/Web%20Client/HTML5Demo-projectresources.zip[HTML5 Demo project resources] |-- 

|link:https://web.archive.org/web/20170713202117/https://netbeans.org/projects/samples/downloads/download/Samples/Web%20Client/HTML5DemoSiteTemplate.zip[Site template of finished project] |-- 
|===

NOTE: The link:https://web.archive.org/web/20170713202117/https://netbeans.org/projects/samples/downloads/download/Samples/Web%20Client/HTML5Demo-projectresources.zip[project resources zip file] contains the JPG images and the CSS file that you need to add to the project in this tutorial.

NOTE: If you would like to compare your project with a working solution, you can download the link:https://web.archive.org/web/20170713202117/https://netbeans.org/projects/samples/downloads/download/Samples/Web%20Client/HTML5DemoSiteTemplate.zip[site template] of the finished project.
...
image::kb/docs/webclient/html5-newproject1.png[title="HTML5 Application template in the New Project wizard"]
...
image::kb/docs/webclient/html5-offline-extension1.png[title="Install Chrome Extension dialog box"]
...
image::kb/docs/webclient/html5-rerun-dialog.png[title="Install Chrome Extension dialog box"]
...
image::kb/docs/webclient/html5-chrome-netbeanshome.png[title="NetBeans Connector page in the Chrome Web Store"]
...
image::kb/docs/webclient/html5-install-extension2.png[title="Confirmation in that extension was installed"]
...
image::kb/docs/webclient/html5-install-extension3.png[title="NetBeans Connector extension is enabled in Chrome Extensions"]
...
image::kb/docs/webclient/html5-install-extension1.png[title="NetBeans Connector extension in Chrome Web Store"]
...
image::kb/docs/webclient/html5-offline-extension2.png[title="NetBeans Connector extension is enabled in Chrome Extensions"]
...
image::kb/docs/webclient/html5-offline-extension3.png[title="NetBeans Connector extension is enabled in Chrome Extensions"]
...
image::kb/docs/webclient/html5-embedded1.png[title="List of target browsers for HTML5 applications in the dropdown list in the toolbar"]
...
image::kb/docs/webclient/html5-embedded2.png[title="Embedded WebKit Browser window"]
...
image::kb/docs/webclient/html5-newproject2.png[title="Site Templates panel in the New HTML5 Application wizard"]
...
image::kb/docs/webclient/html5-newproject3.png[title="Tools panel in the New HTML5 Application wizard"]
...
image::kb/docs/webclient/html5-projectswindow1.png[title="JavaScript Libraries panel in the New HTML5 Application wizard"]
...
image::kb/docs/webclient/html5-runproject.png[title="Application in the Chrome browser tab"]
...
image::kb/docs/webclient/html5-runproject2.png[title="NetBeans menu in the Chrome browser tab"]
...
image::kb/docs/webclient/html5-bower-1.png[title="bower1"]
...
image::kb/docs/webclient/html5-bower-2.png[title="bower2"]
...
image::kb/docs/webclient/html5-bower-3.png[title="bower3"]
...
image::kb/docs/webclient/html5-bower-4.png[title="bower4"]
...
image::kb/docs/webclient/html5-bower-5.png[title="bower5"]
...
image::kb/docs/webclient/html5-bower-6.png[title="bower6"]
...
image::kb/docs/webclient/html5-bower-7.png[title="bower7"]
...
1. Download the link:https://web.archive.org/web/20170713202117/https://netbeans.org/projects/samples/downloads/download/Samples/Web%20Client/HTML5Demo-projectresources.zip[project resources] archive and extract the contents.
...
image::kb/docs/webclient/html5-fileswindow.png[title="NetBeans menu in the Chrome browser tab"]
...
image::kb/docs/webclient/html5-editor1.png[title="Code completion in the editor"]
...
image::kb/docs/webclient/html5-runproject3.png[title="Reloaded page in in the Chrome browser tab"]
...
image::kb/docs/webclient/html5-editor2.png[title="Code completion of CSS rules in the editor"]

If you open the Browser DOM window you can see the current structure of the page.

image::kb/docs/webclient/dom-browser.png[title="Browser DOM window showing DOM tree"]
...
image::kb/docs/webclient/html5-cssstyles.png[title="CSS Styles window"]
...
image::kb/docs/webclient/html5-cssrules.png[title="Edit CSS Rules dialog box"]
...
image::kb/docs/webclient/html5-runproject5.png[title="The final project loaded in the browser"]
...
image::kb/docs/webclient/navigator3.png[title="Browser DOM window"]
...
image::kb/docs/webclient/dom-browser3.png[title="Browser DOM window"]
...
image::kb/docs/webclient/html5-sitetemplate.png[title="Create Site Template dialog box"]

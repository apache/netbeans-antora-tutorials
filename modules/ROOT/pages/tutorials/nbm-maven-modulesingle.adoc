...
image::tutorials/maven-single_71_pic1.png[title="Module wizard 1"]
...
image::tutorials/maven-single_71_pic2.png[title="Module wizard 2"]
...
image::tutorials/maven-single_71_pic4.png[title="Module wizard 2"]
...
image::tutorials/maven-single_71_pic5.png[title="Module wizard 1"]
...
If you don't have an image available, just save this image  `` link:images/maven-crud_abc16.png[abc16.png]`` (image:tutorials/maven-crud_abc16.png[title="16x16"]) to your system and select the image after clicking Browse.


image::tutorials/maven-single_71_pic6.png[title="Module wizard 1"]
...
image::tutorials/maven-single_71_pic8.png[title="Module wizard 1"]
...
image::tutorials/maven-single_71_pic9.png[title="Module wizard 1"]

Click the "Visual" tab and you will see the GUI panel created by the New File Type wizard:


image::tutorials/maven-single_71_pic91.png[title="Module wizard 1"]
...
image::tutorials/maven-single_71_pic92.png[title="Module wizard 1"]
...
image::tutorials/maven-single_71_pic93.png[title="Module wizard 1"]
...
image::tutorials/maven-single_71_pic94.png[title="Module wizard 1"]

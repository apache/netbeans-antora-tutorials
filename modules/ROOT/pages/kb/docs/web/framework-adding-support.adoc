...
image::./add-plugins-sm.png[role="left", link="images/add-plugins.png"]
...
image::./pluginsmanager-settings-sm.png[role="left", link="images/pluginsmanager-settings.png"]
...
image::./portal-uc-plugin-sm.png[role="left", link="images/portal-uc-plugin.png"]
...
image::./portal-uc-list-sm.png[role="left", link="images/portal-uc-list.png"]

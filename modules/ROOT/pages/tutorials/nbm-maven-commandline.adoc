...
image::tutorials/maven-commandline_80_p1.png[title="Screenshot of structure of mavenPlatformApp"]
...
image::tutorials/maven-commandline_72_p2.png[title="Screenshot of default application"]
...
image::tutorials/maven-commandline_72_p3.png[title="Screenshot of default application"]
...
image::tutorials/maven-commandline_72_p4.png[title="Screenshot of structure of mavenplatformmodulea"]

...
image::./01_gb_ui-small.png[role="left", link="images/01_gb_ui.png"]
...
image::./02_add_panels_1-small.png[role="left", link="images/02_add_panels_1.png"]
...
image::./02_add_panels_2-small.png[role="left", link="images/02_add_panels_2.png"]
...
image::./02_add_panels_3-small.png[role="left", link="images/02_add_panels_3.png"]
...
image::./02_add_panels_4-small.png[role="left", link="images/02_add_panels_4.png"]
...
image::./02_add_panels_5-small.png[role="left", link="images/02_add_panels_5.png"]
...
image::./02_add_borders-small.png[role="left", link="images/02_add_borders.png"]
...
2. Click the Align Right in Column button (image:./align_r.png[]) in the toolbar. Alternately, you can right-click either one and choose Align > Right in Column from the pop-up menu.
...
image::./06_align_1-small.png[role="left", link="images/06_align_1.png"]
...
image::./06_align_2-small.png[role="left", link="images/06_align_2.png"]
...
image::./06_align_3-small.png[role="left", link="images/06_align_3.png"]
...
image::./06_align_4-small.png[role="left", link="images/06_align_4.png"]
...
image::./buttons_1-small.png[role="left", link="images/buttons_1.png"]
...
image::./buttons_2-small.png[role="left", link="images/buttons_2.png"]
...
image::./buttons_3-small.png[role="left", link="images/buttons_3.png"]
...
image::./buttons_4-small.png[role="left", link="images/buttons_4.png"]
...
image::./buttons_5-small.png[role="left", link="images/buttons_5.png"]
...
image::./buttons_6-small.png[role="left", link="images/buttons_6.png"]
...
image::./07_indent_1-small.png[role="left", link="images/07_indent_1.png"]
...
image::./07_indent_3-small.png[role="left", link="images/07_indent_3.png"]
...
image::./07_group-small.png[role="left", link="images/07_group.png"]
...
image::./08_cancel-small.png[role="left", link="images/08_cancel.png"]
...
image::./08_same_size-small.png[role="left", link="images/08_same_size.png"]
...
Now that you have successfully built the ContactEditor GUI, you can try your interface to see the results. You can preview your form as you work by clicking the Preview Form button (image:./test_form.png[]) in the GUI Builder's toolbar. The form opens in its own window, allowing you to test it prior to building and running.

[.feature]
--

image::./08_preview_gui-small.png[role="left", link="images/08_preview_gui.png"]

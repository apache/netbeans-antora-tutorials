...
image::kb/docs/javaee/ecommerce/workbench-home.png[role="left", xref="image$./workbench-home.png"]
...
1. In the default interface, begin by creating a new schema which will be used with the `AffableBean` application. Click the plus ( image:kb/docs/javaee/ecommerce/plus-icon.png[] ) icon located to the right of the *Physical Schemata* heading. 

A new panel opens in the bottom region of the interface, enabling you to specify settings for the new schema. 
[.feature]
--

image::kb/docs/javaee/ecommerce/workbench.png[role="left", xref="image$./workbench.png"]
...
image::kb/docs/javaee/ecommerce/affablebean-schema.png[title="Enter settings for 'affablebean' schema"] 
...
1. Under the EER Diagrams heading in WorkBench, double-click the Add Diagram ( image:kb/docs/javaee/ecommerce/add-diagram-btn.png[] ) icon. A new EER Diagram opens displaying an empty canvas. 

[tips]#'EER' stands for Enhanced Entity-Relationship.# 
[.feature]
--

image::kb/docs/javaee/ecommerce/workbench-empty-canvas.png[role="left", xref="image$./workbench-empty-canvas.png"]

--

[start=2]
. Click the New Table ( image:kb/docs/javaee/ecommerce/wb-new-table-icon.png[] ) icon located in the left margin, then hover your mouse onto the canvas and click again. A new table displays on the canvas. 

image::kb/docs/javaee/ecommerce/wb-new-entity-table.png[title="Click the New Table icon to drag empty tables (entities) onto the canvas"]
...
image::kb/docs/javaee/ecommerce/wb-customer-table.png[role="left", xref="image$./wb-customer-table.png"]
...
image::kb/docs/javaee/ecommerce/wb-catalog-tab.png[title="Catalog tab automatically refreshes to display any changes to the schema"]
...
image::kb/docs/javaee/ecommerce/wb-entity-tables.png[title="Create all tables for affablebean schema"]
...
image::kb/docs/javaee/ecommerce/customer-id-column.png[title="Click to edit table columns in the Table editor"]
...
image::kb/docs/javaee/ecommerce/customer-varchar-columns.png[title="Edit inline to add columns to customer table"]
...
image::kb/docs/javaee/ecommerce/customer-table.png[title="'customer' table on EER canvas displays columns"]
...
image::kb/docs/javaee/ecommerce/affablebean-tables.png[title="Use the Table editor to add columns to all tables on canvas"]
...
1. In the left margin, click the 1:n Non-Identifying Relationship ( image:kb/docs/javaee/ecommerce/one-many-btn.png[] ) button. This enables you to create a _one-to-many_ relationship.
...
image::kb/docs/javaee/ecommerce/product-category-relationship.png[title="A one-to-many relationship is defined between the category and product objects"] 
...
image::kb/docs/javaee/ecommerce/foreign-key-tab.png[title="Use the Foreign Key tab to modify a relationship's ordinality and cardinality"] 
...
[start=6]
. Click the 1:n Non-Identifying Relationship ( image:kb/docs/javaee/ecommerce/one-many-btn.png[] ) button. In the following steps, you create a _one-to-many_ relationship between the `customer` and `customer_order` objects.
...
image::kb/docs/javaee/ecommerce/order-customer-relationship.png[title="A one-to-many relationship is defined between the customer and order objects"] 
...
image::kb/docs/javaee/ecommerce/many-to-many.png[title="A many-to-many relationship is depicted as two one-to-many relationships"]
...
1. In the left margin, click the n:m Identifying Relationship ( image:kb/docs/javaee/ecommerce/many-many-btn.png[] ) button. This enables you to create a _many-to-many_ relationship.
...
image::kb/docs/javaee/ecommerce/many-to-many-order-product.png[title="The 'customer_order_has_product' table contains two foreign keys to the order and product tables"] 
...
image::kb/docs/javaee/ecommerce/ordered-product-foreign-key.png[title="Rename the foreign key indexes under the Foreign Keys tab in the Table editor"]
...
image::kb/docs/javaee/ecommerce/quantity-column.png[title="Add a 'quantity' column to the 'order_has_product' table"]
...
image::kb/docs/javaee/ecommerce/affablebean-erd.png[title="ERD for the AffableBean application"]

Choose View > Toggle Grid to disable the canvas grid. You can also create notes for your diagram using the New Text Object ( image:kb/docs/javaee/ecommerce/text-object-btn.png[] ) button in the left margin.
...
image::kb/docs/javaee/ecommerce/inno-db.png[title="Set the default storage engine to InnoDB"] 
...
image::kb/docs/javaee/ecommerce/forward-engineer-wzd.png[title="Enable DROP options to be generated in the SQL script"] 
...
* xref:kb/articles/mysql.adoc[+MySQL and NetBeans IDE+]

...
image::kb/docs/php/unittesting-options.png[]
...
image::kb/docs/php/assert-cc.png[]

image::kb/docs/php/assert-cc-complete.png[]
...
image::kb/docs/php/create-tests.png[]
...
image::kb/docs/php/test-directory.png[]
...
image::kb/docs/php/test-in-folder.png[]
...
image::kb/docs/php/test-class-in-project.png[]
...
image::kb/docs/php/test-results-narrow.png[]

A more verbose textual version of the results is displayed in the Output window.

image::kb/docs/php/test-result-output.png[]
...
image::kb/docs/php/test-group-properties.png[]
...
image::kb/docs/php/production-group-annotation.png[]



. For the methods  ``testAdd2``  and  ``testAdd4`` , add the annotations  ``@group production``  and  ``@group development`` . image:kb/docs/php/production-development-group-code.png[]
...
image::kb/docs/php/select-test-group.png[]
...
image::kb/docs/php/test-results-tooltip.png[]

The Test Results window includes the following buttons on the left side:

* Rerun the test image:kb/docs/php/rerun-button.png[]
* Show failed tests image:kb/docs/php/show-failed.png[]
* Show passed tests image:kb/docs/php/show-passed.png[]
* Show tests that passed but with errors image:kb/docs/php/show-error.png[]
* Navigate between showing the next test result image:kb/docs/php/next-test-button.png[] or the previous test result image:kb/docs/php/previous-test-button.png[]

The Output window shows the full output of the PHPUnit script. It can be useful when you cannot identify the cause of an error with the information in the Test Results window. Like Test Results, the Output window includes links to the test class line that failed. It also includes buttons on the left side for rerunning the test and for opening the PHP Options window. image:kb/docs/php/options-link-button.png[]
...
image::kb/docs/php/turn-on-code-coverage.png[]
...
image::kb/docs/php/editor-bar-before.png[]
...
image::kb/docs/php/editor-bar-after.png[]
...
image::kb/docs/php/code-coverage-report.png[]
...
image::kb/docs/php/code-coverage-report2.png[]
...
image::kb/docs/php/project-ctxmenu.png[]
...
image::kb/docs/php/proj-properties.png[]
...
image::kb/docs/php/proj-properties-selected.png[]
...
image::kb/docs/php/new-selenium.png[]
...
image::kb/docs/php/selenium-test-in-project.png[]

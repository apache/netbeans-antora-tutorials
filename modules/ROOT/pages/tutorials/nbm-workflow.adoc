...
[.feature]
--
image::./workflow_72_easyDoe_thumb.png[role="left", link="https://netbeans.org/images_www/screenshots/platform/easyDoe.png"]
--
...
[.feature]
--
image::./workflow_72_objectreservoir_thumb.jpg[role="left", link="https://netbeans.org/images_www/screenshots/platform/objectreservoir.jpg"]
--
...
image:./javafx_72_new-app-1.png[] Click Next.
...
image::./workflow_72_new-project.png[] 

Click Finish. The IDE creates the  ``PredictionSystem``  project:


image::./workflow_72_new-app.png[]
...
image:./workflow_72_new-app-2.png[] 
...
image:./workflow_72_new-canvas-1.png[] Click Next.

[start=2]
1. Set  ``Specify``  as the project name and leave the other values unchanged: 
image:./workflow_72_new-canvas-2.png[] Click Next.

[start=3]
1. Set  ``org.prediction.specify``  as the module's code name base and set  ``Specify``  as the display name: 
image:./workflow_72_new-canvas-3.png[] Click Finish. You now have your first custom module, named "Specify", for the code relating to the specify step: 
image:./workflow_72_new-canvas-4.png[]

[start=4]
1. Repeat the three steps above twice, to create modules for the steps "diagnose" and "forecast": 
image:./workflow_72_new-canvas-5.png[]
...
image:./workflow_72_new-window-1.png[] Click Next.
...
image:./workflow_72_new-window-2.png[] Click Next.

[start=3]
1. Set  ``SpecifyOne``  (or another suitable name) as the class name prefix: 
image:./workflow_72_new-window-3.png[] Click Finish. You now have your first window, named "SpecifyOneTopComponent", for the code relating to one of the windows in the specify step: 
image:./workflow_72_new-window-4.png[]
...
image:./workflow_72_new-window-5.png[]
...
image:./workflow_72_new-control-1.png[] 
...
image::./workflow_72_new-canvas-6.png[] 
...
image::./workflow_72_new-control-4.png[] 

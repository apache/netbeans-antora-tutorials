...
[.feature]
--
image:./numberslider-small.png[role="left", xref="image$./numberslider.png"]
--
...
image::./numberslider2-small.png[role="left", xref="image$./numberslider2.png"]
...
image::./slider-textfield-small.png[role="left", xref="image$./slider-textfield.png"]
...
image::./bind-dialog-small.png[role="left", xref="image$./bind-dialog.png"]
...
image::./entity-wizard1-small.png[role="left", xref="image$./entity-wizard1.png"]
...
image::./entity-wizard2-small.png[role="left", xref="image$./entity-wizard2.png"]
...
image::./bind-dialog-table-small.png[role="left", xref="image$./bind-dialog-table.png"]
...
image::./source-selected-small.png[role="left", xref="image$./source-selected.png"]
...
image::./jlist-binding-small.png[role="left", xref="image$./jlist-binding.png"]
...
image::./combo-binding-small.png[role="left", xref="image$./combo-binding.png"]
...
image::./custom-small.png[role="left", xref="image$./custom.png"]

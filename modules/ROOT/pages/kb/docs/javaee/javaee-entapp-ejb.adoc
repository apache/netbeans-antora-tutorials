...
image::kb/docs/javaee/new-entapp-wizard.png[title="New Project wizard"]
...
image::kb/docs/javaee/ejb-projectswindow.png[title="Projects window showing structure of the application"] 
...
image::kb/docs/javaee/new-pu-wizard.png[title="Provider and Database panel"]
...
image::kb/docs/javaee/ejb-gettersetter.png[title="Generate Getters and Setters dialog box"]
...
image::kb/docs/javaee/ejb-newmessage.png[title="New Message-Driven Bean Wizard"]
...
image::kb/docs/javaee/ejb-sessionforentity.png[title="New Message-Driven Bean Wizard"]
...
image::kb/docs/javaee/ejb-newsingleton.png[title="Creating a singleton session bean in the New Session Bean wizard"]
...
image::kb/docs/javaee/ejb-implementabstract.png[title="Editor hint to implement abstract methods"]
...
image::kb/docs/javaee/import-jms.png[title="Select the JMS libraries in the Fix All Imports dialog"]
...
image::kb/docs/javaee/ejb-browser1.png[title="The ListNews Servlet page"]

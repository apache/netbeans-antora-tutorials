...
* *hasImageBadge.png* 
image:./povray_hasImageBadge.png[]
* *hasNoImageBadge.png* 
image:./povray_hasNoImageBadge.png[]
* *needsRenderBadge.png* 
image:./povray_needsRenderBadge.png[]
